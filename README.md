...
| [`./apps/get.status.app`](./apps/get.status.app) | [![vercel](https://img.shields.io/badge/vercel-black)](https://get.status.app)                                                             |                                                                                                                          | Download-focused subset of status.app (home, apps, legal, security).                                              |
