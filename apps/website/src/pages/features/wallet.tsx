    ...
    <div className="overflow-hidden pt-16 lg:pt-32">
      ...
      <div className="relative pt-[220px]">
        ...
        <TwoColsSection
          ...
          image="/assets/wallet/4.png"
          imageAlt="wallet-2"
          imageSecondary="/assets/wallet/skull.png"
      ...
      <div className="relative pt-[160px]">
        <TwoColsSection
          ...
          image="/assets/wallet/5.png"
          imageAlt="wallet-5"
          imageSecondary="/assets/wallet/pizza.png"
      ...
      <div className="relative py-[160px]">
        <TwoColsSection
          ...
          image="/assets/wallet/6.png"
          imageAlt="wallet-6"
          imageSecondary="/assets/wallet/duck.png"
      ...
      <div className="border-neutral-10 bg-white-100 relative rounded-[48px] border-t py-[160px] mix-blend-normal shadow-[0_-2px_20px_rgba(9,16,28,0.04)]">
        <TwoColsSection
          ...
          image="/assets/wallet/7.png"
          imageAlt="wallet-7"
          imageSecondary="/assets/wallet/cube.png"
        ...
        <div className="relative pt-[160px]">
          <TwoColsSection
            ...
            image="/assets/wallet/8.png"
            imageAlt="wallet-8"
            imageSecondary="/assets/wallet/megaphone.png"
