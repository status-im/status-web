...
Yes. The source code of [Status Mobile](https://github.com/status-im/status-app), [Status Desktop](https://github.com/status-im/status-app) and [Status Web](https://github.com/status-im/status-web) is fully available on GitHub, including the Wallet's source code.
