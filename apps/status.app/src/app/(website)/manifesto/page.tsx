        ...
        <div className="container relative">
          <div className="flex flex-col items-center">
            <p className="max-w-[702px] text-27 font-regular xl:text-40 xl:font-regular">
              ...
              <br />
              <br />
              We believe that a free cyberspace will enable people to innovate
              and experiment with new forms of{' '}
              ...
              imposed by centralised institutions and monopolistic tech
              platforms.
              <br />
              <br />
              ...
              decentralised and permissionless innovation, directly accessible
