...
type Props = {
  ...
  innerHeight: number
  numTicksX: number
  totalDevicesData: Datum[]
  verifiedDevicesData: Datum[]
}
...
const Content = (props: Props) => {
  ...
  // When the component mounts, animate the dotted line otherwise the animation will not be triggered
  useIsomorphicLayoutEffect(() => {
    apiDotted.start({
      from: {
        strokeDasharray: '0 0',
