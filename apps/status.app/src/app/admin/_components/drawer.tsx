...
const contentStyles = cva(
  'shadow fixed flex flex-col gap-3 rounded-16 border border-neutral-10 bg-white-100 px-3 py-4 transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 z-auto',
  {
    variants: {
      side: {
