  ...
  const coins = [
    {
      ...
      src: '/hero/waifu.png',
      className:
        '-ml-20 md:-ml-10 left-1/4 mt-0 2xl:mt-0 lg:ml-0 max-w-[320px] lg:max-w-[450px] 2xl:max-w-[540px]',
    },
    {
      x: 745,
      y: 610,
      ...
      src: '/hero/key.png',
      className:
        'right-1/4 -mr-20 lg:mt-0 lg:mr-0 -mt-20 max-w-[130px] lg:max-w-[220px]',
    },
    {
      x: 545,
      y: 780,
      ...
      src: '/hero/dragon.png',
      className:
        '-mr-20 -mt-32 right-1/4 lg:mt-10 2xl:mt-0 md:mr-0 max-w-[200px] lg:max-w-[300px] 2xl:max-w-[450px]',
    },
    {
      y: 620,
      delay: 0.2,
