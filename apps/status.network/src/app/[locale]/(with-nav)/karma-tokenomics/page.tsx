...
export default async function KarmaTokenomicsPage({ params }: Props) {
  await params
  ...
  return (
    <>
      ...
      <div className="px-5 pb-16 pt-10 xl:pb-24 xl:pt-16">
        <div className="mx-auto w-full max-w-6xl">
          <div className="mx-auto mb-10">
            ...
            <p className="mt-4 text-19 text-neutral-80/60">{meta.subtitle}</p>
          </div>
          <article
            className={[
