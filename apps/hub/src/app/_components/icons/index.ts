...
export { default as FundingPoolIcon } from './funding-pool-icon'
export { default as GovernanceIcon } from './governance-icon'
export { default as GusdIcon } from './gusd-icon'
...
export { default as KarmaCircleIcon } from './karma-circle-icon'
...
export { default as SumIcon } from './sum-icon'
