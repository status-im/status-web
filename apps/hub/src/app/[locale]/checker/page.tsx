        ...
        <section className="flex flex-col gap-6">
          <div className="max-w-[760px]">
            ...
            <p className="mt-6 max-w-[720px] text-19 leading-[1.55] text-neutral-60">
              Enter a wallet address or ENS to see estimated LINEA + SNT
              rewards, and ETH + stablecoin yield from the Status Network
              pre-deposit vault campaign
            </p>
          </div>
        ...
        <section id="methodology" className="flex flex-col gap-4">
          ...
          <article className="rounded-20 border border-neutral-10 bg-white-100 p-5">
            ...
            <p className="mt-2 text-15 leading-[1.55] text-neutral-70">
              A small number of smart wallets and old multisigs need a
              deployable Linea address to receive the airdrops. Those
              allocations will be held until a valid Linea Mainnet address is
              created. Starting June 9th, the remaining allocated rewards and
              yield will be bridged back to Ethereum and distributed there.
            </p>
          </article>
