  ...
  manifest: ({ mode }) => {
    ...
    const connectSrc =
      mode === 'production'
        ...
        : `ws: http://localhost:3030/ https://localhost:3030/ http://127.0.0.1:8545/ http://localhost:8545/ ws://127.0.0.1:8545/ ws://localhost:8545/ https://li.quest/ https://registry.npmjs.org/ ${rpcEndpoints}`
