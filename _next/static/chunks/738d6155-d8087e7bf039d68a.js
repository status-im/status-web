...
`,eB="auto",eD=eL(W.P.div)`
  ...
  ${e=>{switch(eB){case"light":return eT;case"dark":return ez;default:return(0,B.AH)`
          ${eT}
          @media (prefers-color-scheme: dark) {
            ${ez}
          }
...
`,eR=e=>{let{selector:n,children:t}=e={selector:"__CONNECTKIT__",...e},o=(0,I.useRef)(null),[i,r]=(0,I.useState)(!1);return((0,I.useEffect)(()=>{let e="#"+n.replace(/^#/,"");if(o.current=document.querySelector(e),!o.current){let e=document.createElement("div");e.setAttribute("id",n),e.setAttribute("data-connectkit",`${rK}`),document.body.appendChild(e),o.current=e}r(!0)},[n]),o.current&&i)?(0,D.createPortal)(t,o.current):null};var eH={mobileWidth:560};let eU=eL(W.P.div)`
  z-index: -1;
  pointer-events: auto;
  position: absolute;
  left: 50%;
...
`;let e2=eL(W.P.div)`
  ...
  opacity: 0;
  animation: ${e=>e.$active?eZ:eV} 150ms ease-out
    both;
`,e3=(0,B.i7)`
...
Vui l\xf2ng thử lại.`,injectionScreen_notconnected_h1:`Đăng nhập v\xe0o {{ CONNECTORNAME }}`,injectionScreen_notconnected_p:`Để tiếp tục, vui l\xf2ng đăng nhập bằng tiện \xedch {{ CONNECTORNAME }}.`,profileScreen_heading:"Đ\xe3 kết nối",switchNetworkScreen_heading:"Đổi mạng",signInWithEthereumScreen_tooltip:"Bạn chưa đăng nhập v\xe0o ứng dụng.\n**Đăng nhập qua Ethereum** để tiếp tục.",signInWithEthereumScreen_signedOut_heading:"Đăng nhập qua Ethereum",signInWithEthereumScreen_signedOut_h1:"Ứng dụng n\xe0y muốn x\xe1c nhận bạn \n l\xe0 chủ sở hữu của v\xed.",signInWithEthereumScreen_signedOut_p:`Vui l\xf2ng k\xfd tin nhắn y\xeau cầu 
 ...
 x\xe1c nhận lại trong l\xe0n tiếp theo.`,signInWithEthereumScreen_signedIn_button:"Đăng xuất"},nH=e=>{switch(e){case"ee-EE":return nM;case"ar-AE":return n_;case"es-ES":return nA;case"fa-IR":return nI;case"fr-FR":return nF;case"ja-JP":return nO;case"pt-BR":return nW;case"ru-RU":return nT;case"zh-CN":return nz;case"ca-AD":return nB;case"tr-TR":return nD;case"vi-VN":return nR;default:return nL}};function nU(e){var n,t;let o=null!=(t=null==(n=rM().options)?void 0:n.language)?t:"en-US",i=(0,I.useMemo)(()=>nH(o),[o]);if(!i)throw console.error(`Missing translations for: ${o}`),Error(`Missing translations for: ${o}`);let r={};return Object.keys(i).map(n=>{let t=i[n];return r[n]=nZ(t,e)}),r}let nZ=(e,n)=>{let t=e;return n&&Object.keys(n).forEach(e=>{t=t.replace(RegExp(`({{ ${e} }})`,"g"),n[e])}),nG(t)},nG=e=>{let n=e;return n=(n=n.split("\n")).map((e,t)=>(0,A.jsxs)(I.Fragment,{children:[nP(e),t<n.length-1&&(0,A.jsx)("br",{})]},t))},nP=e=>e.split(/(\*\*[^\*]*\*\*)/g).map((e,n)=>/(\*\*.*\*\*)/g.test(e)?(0,A.jsx)("strong",{children:e.replace(/\*\*/g,"")},n):`${e}`).map(e=>"string"==typeof e?e.split(/(\[WALLETCONNECTLOGO\])/g).map(e=>"[WALLETCONNECTLOGO]"===e?(0,A.jsx)("span",{className:"ck-tt-logo",children:(0,A.jsx)(el.WalletConnect,{})},e):e):e),nV={debug:10,info:20,warn:30,error:40,none:100},nY="undefined"!=typeof window&&window.document&&void 0!==window.document.createElement?I.useLayoutEffect:I.useEffect,nQ=({logLevel:e="info",maxFontSize:n=100,minFontSize:t=20,onFinish:o,onStart:i,resolution:r=5}={})=>{let a=nV[e],s=(0,I.useCallback)(()=>({calcKey:0,fontSize:n,fontSizePrev:t,fontSizeMax:n,fontSizeMin:t}),[n,t]),c=(0,I.useRef)(null),l=(0,I.useRef)(),d=(0,I.useRef)(!1),[p,h]=(0,I.useState)(s),{calcKey:u,fontSize:g,fontSizeMax:x,fontSizeMin:b,fontSizePrev:C}=p,m=null,[f]=(0,I.useState)(()=>new Z.A(()=>{m=window.requestAnimationFrame(()=>{d.current||(i&&i(),d.current=!0,h({...s(),calcKey:u+1}))})}));(0,I.useEffect)(()=>(c.current&&f.observe(c.current),()=>{m&&window.cancelAnimationFrame(m),f.disconnect()}),[m,f]);let k=c.current&&c.current.innerHTML;return(0,I.useEffect)(()=>{0===u||d.current||(k!==l.current&&(i&&i(),h({...s(),calcKey:u+1})),l.current=k)},[u,s,k,i]),nY(()=>{let e;if(0===u)return;let n=Math.abs(g-C)<=r,i=!!c.current&&(c.current.scrollHeight>c.current.offsetHeight||c.current.scrollWidth>c.current.offsetWidth),s=i&&g===C,l=g>C;if(n)return void(s?(d.current=!1,a<=nV.info&&console.info(`[use-fit-text] reached \`minFontSize = ${t}\` without fitting text`)):i?h({fontSize:l?C:b,fontSizeMax:x,fontSizeMin:b,fontSizePrev:C,calcKey:u}):(d.current=!1,o&&o(g)));let p=x,m=b;i?(e=l?C-g:b-g,p=Math.min(x,g)):(e=l?x-g:C-g,m=Math.max(b,g)),h({calcKey:u,fontSize:g+e/2,fontSizeMax:p,fontSizeMin:m,fontSizePrev:g})},[u,g,x,b,C,o,c,r]),{fontSize:g,ref:c}},nX=({children:e})=>{let[n,t]=I.useState(!1),{fontSize:o,ref:i}=nQ({logLevel:"none",maxFontSize:100,minFontSize:70,onStart:()=>t(!0),onFinish:()=>t(!0)});return(0,A.jsx)("div",{ref:i,style:{visibility:n?"visible":"hidden",fontSize:`${o}%`,maxHeight:"100%",maxWidth:"100%",display:"flex",justifyContent:"center",alignItems:"center"},children:e})};function nJ(){let e=(0,s.U)();return null!=e?e:[]}function nq(e,n){let t=nJ();return"injected"===e&&n?t.find(t=>t.id===e&&t.name===n):"injected"===e?t.find(n=>n.id===e&&n.name.includes("Injected")):t.find(n=>n.id===e)}function nK(){return nq("familyAccountsProvider")}function n$(){return nq("co.family.wallet")}nX.displayName="FitText";let n1=e=>{let n=n0().find(n=>n.id===e);return n||null},n0=()=>{let e=nJ(),n=rM();return e.map(e=>{var n,t;let o=Object.keys(eS).find(n=>-1!==n.split(",").map(e=>e.trim()).indexOf(e.id)),i={id:e.id,name:null!=(t=null!=(n=e.name)?n:e.id)?t:e.type,icon:(0,A.jsx)("img",{src:e.icon,alt:e.name,width:"100%",height:"100%"}),connector:e,iconShape:"squircle",isInstalled:"mock"===e.type||"injected"===e.type&&"metaMask"!==e.id||ew(e.id)};if(o){let n=eS[o];return{...i,iconConnector:e.icon?(0,A.jsx)("img",{src:e.icon,alt:e.name,width:"100%",height:"100%"}):void 0,...n}}return i}).filter((e,n,t)=>t.findIndex(n=>n.id===e.id)===n).map(e=>{var t,o;return"walletConnect"===e.id?{...e,name:(null==(t=n.options)?void 0:t.walletConnectName)||e.name,shortName:(null==(o=n.options)?void 0:o.walletConnectName)||e.shortName}:e}).filter((e,n,t)=>!("coinbaseWalletSDK"===e.id&&t.find(e=>"com.coinbase.wallet"===e.id))).filter((e,n,t)=>!(("metaMaskSDK"===e.id||"metaMask"===e.id)&&t.find(e=>"io.metamask"===e.id||"io.metamask.mobile"===e.id))).sort((e,n)=>{let t=e.isInstalled&&ej(e.connector.type),o=n.isInstalled&&ej(n.connector.type);return t&&!o?-1:!t&&o?1:0}).sort((e,n)=>"walletConnect"===e.id?1:"walletConnect"===n.id?-1:0)},n2=({isSignedIn:e})=>(0,A.jsxs)("div",{style:{position:"relative"},children:[e?(0,A.jsx)(nS,{style:{bottom:-1,right:-1}}):(0,A.jsx)("div",{style:{zIndex:2,position:"absolute",top:-2,right:-2,background:"#1A88F8",borderRadius:8,boxShadow:"0 0 0 2px var(--ck-body-background)",width:8,height:8}}),(0,A.jsxs)("svg",{"aria-hidden":"true",width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",style:{overflow:"visible"},children:[(0,A.jsx)("circle",{cx:"10",cy:"10",r:"9",stroke:"currentColor",strokeWidth:"2"}),(0,A.jsx)("path",{d:"M16.5 16.775C14.8618 15.0649 12.5552 14 10 14C7.44477 14 5.13825 15.0649 3.5 16.775",stroke:"currentColor",strokeWidth:"2"}),(0,A.jsx)("circle",{cx:"10",cy:"8",r:"3",stroke:"currentColor",strokeWidth:"2"})]})]}),n3=({...e})=>(0,A.jsx)("svg",{"aria-hidden":"true",width:"22",height:"22",viewBox:"0 0 22 22",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,A.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M20 11C20 15.9706 15.9706 20 11 20C6.02944 20 2 15.9706 2 11C2 6.02944 6.02944 2 11 2C15.9706 2 20 6.02944 20 11ZM22 11C22 17.0751 17.0751 22 11 22C4.92487 22 0 17.0751 0 11C0 4.92487 4.92487 0 11 0C17.0751 0 22 4.92487 22 11ZM11.6445 12.7051C11.6445 13.1348 11.3223 13.4678 10.7744 13.4678C10.2266 13.4678 9.92578 13.1885 9.92578 12.6191V12.4795C9.92578 11.4268 10.4951 10.8574 11.2686 10.3203C12.2031 9.67578 12.665 9.32129 12.665 8.59082C12.665 7.76367 12.0205 7.21582 11.043 7.21582C10.3232 7.21582 9.80762 7.57031 9.45312 8.16113C9.38282 8.24242 9.32286 8.32101 9.2667 8.39461C9.04826 8.68087 8.88747 8.8916 8.40039 8.8916C8.0459 8.8916 7.66992 8.62305 7.66992 8.15039C7.66992 7.96777 7.70215 7.7959 7.75586 7.61328C8.05664 6.625 9.27051 5.75488 11.1182 5.75488C12.9336 5.75488 14.5234 6.71094 14.5234 8.50488C14.5234 9.7832 13.7822 10.417 12.7402 11.1045C11.999 11.5986 11.6445 11.9746 11.6445 12.5762V12.7051ZM11.9131 15.5625C11.9131 16.1855 11.376 16.6797 10.7529 16.6797C10.1299 16.6797 9.59277 16.1748 9.59277 15.5625C9.59277 14.9395 10.1191 14.4453 10.7529 14.4453C11.3867 14.4453 11.9131 14.9287 11.9131 15.5625Z",fill:"currentColor"})}),n5=({...e})=>(0,A.jsx)(W.P.svg,{width:14,height:14,viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,A.jsx)("path",{d:"M1 13L13 1M1 1L13 13",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round"})}),n4=({...e})=>(0,A.jsx)(W.P.svg,{width:9,height:16,viewBox:"0 0 9 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,A.jsx)("path",{d:"M8 1L1 8L8 15",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),n9={initial:{zIndex:2,opacity:0},animate:{opacity:1,scale:1,transition:{duration:.165,delay:.055,ease:[.26,.08,.25,1]}},exit:{zIndex:1,opacity:0,pointerEvents:"none",position:"absolute",left:["50%","50%"],x:["-50%","-50%"],transition:{duration:.22,ease:[.26,.08,.25,1]}}},n8=({open:e,pages:n,pageId:t,positionInside:o,inline:i,demo:r,onClose:a,onBack:s,onInfo:d})=>{var p,h,u,g,x,b,C,m,f,k,v,w;let y,j=rM(),S=nC(),N=em(),{isSignedIn:E,reset:L}=nE(),_=n1(null==(p=j.connector)?void 0:p.id),M={name:null==_?void 0:_.name,shortName:null!=(h=null==_?void 0:_.shortName)?h:null==_?void 0:_.name,icon:null!=(u=null==_?void 0:_.iconConnector)?u:null==_?void 0:_.icon,iconShape:null!=(g=null==_?void 0:_.iconShape)?g:"circle",iconShouldShrink:null==_?void 0:_.iconShouldShrink},F=nU({CONNECTORNAME:null==M?void 0:M.name}),[O,z]=(0,V.p)({timeout:160,preEnter:!0,mountOnEnter:!0,unmountOnExit:!0}),B="exited"!==O&&"unmounted"!==O,D="preEnter"===O||"exiting"!==O,R=j.route===rE.CONNECTORS?0:j.route===rE.DOWNLOAD?2:1,H=ng(R,R);o||nh(B),ng(t,t),(0,I.useEffect)(()=>{z(e),e&&P(void 0)},[e]);let[U,Z]=(0,I.useState)({width:void 0,height:void 0}),[G,P]=(0,I.useState)(void 0),Y=e=>{let n={width:null==e?void 0:e.offsetWidth,height:null==e?void 0:e.offsetHeight};Z({width:`${null==n?void 0:n.width}px`,height:`${null==n?void 0:n.height}px`})},Q=(0,I.useCallback)(e=>{e&&(q.current=e,P(void 0!==G),clearTimeout(y),y=setTimeout(()=>P(!1),360),Y(e))},[e,G]),{chain:X}=(0,c.F)(),{switchChain:J}=(0,l.R)(),q=(0,I.useRef)(null);(0,I.useEffect)(()=>{q.current&&Y(q.current)},[X,J,N,E,j.options,j.resize]),(0,I.useEffect)(()=>{if(!B)return void Z({width:void 0,height:void 0});let e=e=>{"Escape"===e.key&&a&&a()};return document.addEventListener("keydown",e),()=>{document.removeEventListener("keydown",e)}},[B,a]);let K={"--height":U.height,"--width":U.width},$=(0,A.jsx)(eD,{$useTheme:null!=(x=null==r?void 0:r.theme)?x:S.theme,$useMode:null!=(b=null==r?void 0:r.mode)?b:S.mode,$customTheme:null!=(C=null==r?void 0:r.customTheme)?C:S.customTheme,children:(0,A.jsxs)(nt,{role:"dialog",style:{pointerEvents:D?"auto":"none",position:o?"absolute":void 0},children:[!i&&(0,A.jsx)(e2,{$active:D,onClick:a,$blur:null==(m=j.options)?void 0:m.overlayBlur}),(0,A.jsxs)(ns,{style:K,initial:!1,children:[(0,A.jsx)("div",{style:{pointerEvents:G?"all":"none",position:"absolute",top:0,bottom:0,left:"50%",transform:"translateX(-50%)",width:"var(--width)",zIndex:9,transition:"width 200ms ease"}}),(0,A.jsxs)(e8,{className:`${D&&"active"}`,children:[(0,A.jsx)(T.N,{initial:!1,children:(null==(f=j.options)?void 0:f.disclaimer)&&j.route===rE.CONNECTORS&&(0,A.jsx)(nl,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{delay:0,duration:.2,ease:[.25,.1,.25,1]},children:(0,A.jsx)(nc,{children:(0,A.jsx)("div",{children:null==(k=j.options)?void 0:k.disclaimer})})})}),(0,A.jsx)(T.N,{initial:!1,children:j.errorMessage&&(0,A.jsxs)(eU,{initial:{y:"10%",x:"-50%"},animate:{y:"-100%"},exit:{y:"100%"},transition:{duration:.2,ease:"easeInOut"},children:[(0,A.jsx)("span",{children:j.errorMessage}),(0,A.jsx)("div",{onClick:()=>j.displayError(null),style:{position:"absolute",right:24,top:24,cursor:"pointer"},children:(0,A.jsx)(n5,{})})]})}),(0,A.jsxs)(e6,{children:[a&&(0,A.jsx)(no,{"aria-label":ef(F.close).toString(),onClick:a,children:(0,A.jsx)(n5,{})}),(0,A.jsx)("div",{style:{position:"absolute",top:23,left:20,width:32,height:32},children:(0,A.jsx)(T.N,{children:s?(0,A.jsx)(nr,{disabled:G,"aria-label":ef(F.back).toString(),onClick:s,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.1*!N,delay:.01*!!N},children:(0,A.jsx)(n4,{})},"backButton"):j.route===rE.PROFILE&&j.signInWithEthereum?(0,A.jsxs)(A.Fragment,{children:[!E&&!(null==(v=j.options)?void 0:v.hideTooltips)&&(0,A.jsx)(W.P.div,{style:{position:"absolute",inset:0,pointerEvents:"none"},initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1,transition:{delay:.5,duration:.2}},exit:{opacity:0,scale:.6,transition:{delay:0,duration:.1*!N}},children:(0,A.jsx)(nd,{children:F.signInWithEthereumScreen_tooltip})}),(0,A.jsx)(ni,{disabled:G,"aria-label":F.signInWithEthereumScreen_signedOut_heading,onClick:()=>{L(),j.setRoute(rE.SIGNINWITHETHEREUM)},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.1*!N,delay:.01*!!N},children:(0,A.jsx)(n2,{isSignedIn:E})},"siweButton")]}):d&&!(null==(w=j.options)?void 0:w.hideQuestionMarkCTA)&&(0,A.jsx)(na,{disabled:G,"aria-label":ef(F.moreInformation).toString(),onClick:d,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.1*!N,delay:.01*!!N},children:(0,A.jsx)(n3,{})},"infoButton")})})]}),(0,A.jsx)(eq,{children:(0,A.jsx)(T.N,{children:(0,A.jsx)(W.P.div,{style:{position:"absolute",top:0,bottom:0,left:52,right:52,display:"flex",justifyContent:"center"},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.17*!N,delay:.01*!!N},children:(0,A.jsx)(nX,{children:function(){var e;switch(j.route){case rE.ABOUT:return F.aboutScreen_heading;case rE.CONNECT:if(_&&!(!_.getWalletConnectDeeplink||_.isInstalled))return ek(null==(e=null==_?void 0:_.connector)?void 0:e.id)?F.scanScreen_heading:F.scanScreen_heading_withConnector;return null==M?void 0:M.name;case rE.CONNECTORS:return F.connectorsScreen_heading;case rE.MOBILECONNECTORS:return F.mobileConnectorsScreen_heading;case rE.DOWNLOAD:return F.downloadAppScreen_heading;case rE.ONBOARDING:return F.onboardingScreen_heading;case rE.PROFILE:return F.profileScreen_heading;case rE.SWITCHNETWORKS:return F.switchNetworkScreen_heading;case rE.SIGNINWITHETHEREUM:return E?F.signInWithEthereumScreen_signedIn_heading:F.signInWithEthereumScreen_signedOut_heading;default:return""}}()})},`${j.route}-${E?"signedIn":""}`)})}),(0,A.jsx)(e7,{children:Object.keys(n).map(e=>{let i=n[e];return(0,A.jsx)(n6,{open:e===t,initial:!o&&"entered"!==O,enterAnim:e===t?R>H?"active-scale-up":"active":"",exitAnim:e!==t?R<H?"exit-scale-down":"exit":"",children:(0,A.jsx)(nn,{ref:Q,style:{pointerEvents:e===t&&D?"auto":"none"},children:i},`inner-${e}`)},e)})})]})]})]})});return(0,A.jsx)(A.Fragment,{children:B&&(0,A.jsx)(A.Fragment,{children:o?$:(0,A.jsx)(A.Fragment,{children:(0,A.jsx)(eR,{children:(0,A.jsx)(nu,{children:$})})})})})},n6=({children:e,open:n,initial:t,prevDepth:o,currentDepth:i,enterAnim:r,exitAnim:a})=>{let[s,c]=(0,V.p)({timeout:400,preEnter:!0,initialEntered:n,mountOnEnter:!0,unmountOnExit:!0});return((0,I.useEffect)(()=>{c(n)},[n]),"exited"===s||"unmounted"===s)?null:(0,A.jsx)(ne,{className:`${"preEnter"===s||"exiting"!==s?r:a}`,style:{animationDuration:t?"0ms":void 0,animationDelay:t?"0ms":void 0},children:e})},n7=({children:e,hideHr:n})=>{let t=nU();return(0,A.jsx)(eJ,{$disableHr:n,children:(0,A.jsx)("span",{children:null!=e?e:t.or})})},te=eL(W.P.div)`
  position: relative;
...
`,tN={duration:.4,ease:[.175,.885,.32,.98]},tE=()=>(0,A.jsx)(tS,{initial:{opacity:0,rotate:180},animate:{opacity:1,rotate:0},exit:{position:"absolute",opacity:0,rotate:-180,transition:{...tN}},transition:{...tN,delay:.2},children:(0,A.jsxs)("svg",{width:"18",height:"18",viewBox:"0 0 18 18",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("circle",{cx:"9",cy:"9",r:"7",stroke:"currentColor",strokeOpacity:"0.1",strokeWidth:"2.5"}),(0,A.jsx)("path",{d:"M16 9C16 5.13401 12.866 2 9 2",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round"})]})}),tL={duration:.4,ease:[.175,.885,.32,.98]},t_=({children:e,variant:n="secondary",disabled:t,icon:o,iconPosition:i="left",roundedIcon:r,waiting:a,arrow:s,download:c,href:l,style:d,onClick:p})=>{let h="string"==typeof e?e:ef(e).join(""),u=l&&("string"==typeof l?l:ef(l).join(""));return(0,A.jsx)(tv,{as:l?"a":void 0,onClick:e=>{!t&&p&&p(e)},href:u,target:l&&"_blank",rel:l&&"noopener noreferrer",disabled:t,$variant:n,style:d,children:(0,A.jsxs)(T.N,{initial:!1,children:[(0,A.jsxs)(tk,{initial:{opacity:0,y:-10},animate:{opacity:1,y:-1},exit:{position:"absolute",opacity:0,y:10,transition:{...tL}},transition:{...tL,delay:.2},children:[o&&"left"===i&&(0,A.jsx)(ty,{$rounded:r,children:o}),c&&(0,A.jsx)(tm,{children:(0,A.jsx)(tf,{children:(0,A.jsxs)(tx,{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)(tC,{stroke:"currentColor",x1:"1",y1:"6",x2:"12",y2:"6",strokeWidth:"var(--stroke-width)",strokeLinecap:"round"}),(0,A.jsx)(tb,{stroke:"currentColor",d:"M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314",strokeWidth:"var(--stroke-width)",strokeLinecap:"round"})]})})}),(0,A.jsx)(tw,{style:{paddingLeft:6*!!s},children:(0,A.jsx)(nX,{children:e})}),o&&"right"===i&&(0,A.jsx)(ty,{$rounded:r,children:o}),s&&(0,A.jsxs)(tx,{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)(tC,{stroke:"currentColor",x1:"1",y1:"6",x2:"12",y2:"6",strokeWidth:"2",strokeLinecap:"round"}),(0,A.jsx)(tb,{stroke:"currentColor",d:"M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314",strokeWidth:"2",strokeLinecap:"round"})]})]},h),a&&(0,A.jsx)(tg,{children:(0,A.jsx)(tE,{})})]})})},tM=()=>{var e,n;let t=rM(),o=nU({}),i=null!=(n=null==(e=t.options)?void 0:e.walletOnboardingUrl)?n:o.onboardingScreen_ctaUrl;return(0,A.jsxs)(eX,{children:[(0,A.jsxs)(te,{children:[(0,A.jsxs)(tn,{children:[(0,A.jsx)(th,{children:(0,A.jsx)(tr,{children:(0,A.jsx)(ta,{children:(0,A.jsx)(tl,{children:(0,A.jsx)(tp,{children:(0,A.jsx)(ts,{children:(0,A.jsx)(el.Coinbase,{background:!0})})})})})})}),(0,A.jsx)(th,{children:(0,A.jsx)(tr,{children:(0,A.jsx)(ta,{children:(0,A.jsx)(tl,{children:(0,A.jsx)(tp,{children:(0,A.jsx)(ts,{children:(0,A.jsx)(el.MetaMask,{background:!0})})})})})})}),(0,A.jsx)(th,{children:(0,A.jsx)(tr,{children:(0,A.jsx)(ta,{children:(0,A.jsx)(tl,{children:(0,A.jsx)(tp,{children:(0,A.jsx)(ts,{children:(0,A.jsx)(el.Trust,{})})})})})})}),(0,A.jsx)(th,{children:(0,A.jsx)(tr,{children:(0,A.jsx)(ta,{children:(0,A.jsx)(tl,{children:(0,A.jsx)(tp,{children:(0,A.jsx)(ts,{children:(0,A.jsx)(el.Argent,{})})})})})})}),(0,A.jsx)(th,{children:(0,A.jsx)(tr,{children:(0,A.jsx)(ta,{children:(0,A.jsx)(tl,{children:(0,A.jsx)(tp,{children:(0,A.jsx)(ts,{children:(0,A.jsx)(el.ImToken,{})})})})})})})]}),(0,A.jsx)(to,{children:tu})]}),(0,A.jsxs)(e$,{style:{paddingBottom:18},children:[(0,A.jsx)(e1,{$small:!0,children:o.onboardingScreen_h1}),(0,A.jsx)(e0,{children:o.onboardingScreen_p})]}),(0,A.jsx)(t_,{href:i,arrow:!0,children:o.onboardingScreen_ctaText})]})},tA=eL.div`
  pointer-events: none;
  user-select: none;
  height: ${208}px;
  padding: 0 0 12px;
...
`,tB=eL.button`
  ...
  ${e=>e.$active?(0,B.AH)`
        ...
        `}
`,tD={scale:[.9,1.25,1.6],opacity:[0,.11,0]},tR={ease:"linear",duration:2,repeat:1/0},tH=eL.div`
  position: absolute;
  left: 50%;
  top: 50%;
...
`,tZ=eL(W.P.div)`
  ...
  overflow: hidden;
  border-radius: 100%;
  animation: ${tU} 16s linear infinite;
`,tG=eL(W.P.div)`
  overflow: hidden;
...
`,oa=eL.div`
  ...
  ${e=>e.$mobile?(0,B.AH)`
        ...
        `}
`;function os(){var e;let n=(0,d.U)();return(null!=(e=null==n?void 0:n.chains)?e:[]).map(e=>e)}function oc({...e}={}){let n=rM(),{connect:t,connectAsync:o,connectors:i,...r}=(0,p.e)({...e,mutation:{...e.mutation,onError(e){e.message?"User rejected request"!==e.message&&n.log(e.message,e):n.log("Could not connect.",e)}}});return{connect:({connector:e,chainId:o,mutation:i})=>{var r;return t({connector:e,chainId:null!=o?o:null==(r=n.options)?void 0:r.initialChainId},i)},connectAsync:async({connector:e,chainId:t,mutation:i})=>{var r;return o({connector:e,chainId:null!=t?t:null==(r=n.options)?void 0:r.initialChainId},i)},connectors:i,...r}}function ol(e){let{chains:n}=(0,d.U)();return!!e&&n.some(n=>n.id===e)}let od=I.createContext({connect:{getUri:()=>""},dapp:{chains:[]},account:void 0}),op=({enabled:e,children:n})=>{let{uri:t}=function({enabled:e}={enabled:!0}){let{log:n}=rM(),[t,o]=(0,I.useState)(void 0),i=nq("walletConnect"),{isConnected:r}=(0,c.F)(),{connectAsync:a}=oc();return(0,I.useEffect)(()=>{if(e)if(r)o(void 0);else{if(!i||t)return;if(i&&!r)return d(i),n("add wc listeners"),i.emitter.on("message",s),i.emitter.on("disconnect",c),()=>{n("remove wc listeners"),i.emitter.off("message",s),i.emitter.off("disconnect",c)}}async function s(e){let{type:t,data:i}=e;n("WC Message",t,i),"display_uri"===t&&o(i)}async function c(){n("WC Disconnect"),i&&l(i)}async function l(e){let n=await a({connector:e});return!!n&&n}async function d(e){try{await l(e)}catch(t){n("catch error"),n(t),t.code?4001===t.code?(n("error.code - User rejected"),d(e)):n("error.code - Unknown Error"):n("WalletConnect cannot connect.",t)}}},[e,i,r]),{uri:t}}({enabled:e}),{address:o,chain:i}=(0,c.F)(),r=ol(null==i?void 0:i.id),a=os();return(0,A.jsx)(od.Provider,{value:{connect:{getUri:e=>t},dapp:{chains:a},account:o?{chain:i,chainIsSupported:r,address:o}:void 0},children:n})},oh=()=>I.useContext(od);function ou(){let[e,n]=(0,I.useState)(em());return(0,I.useEffect)(()=>{let e=()=>{n(em())};return window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[]),e}let og=eL.div`
  position: relative;
`,ox=(0,B.i7)`
0%{ opacity:0; }
100%{ opacity:1; }
...
`,om=()=>(0,A.jsx)("svg",{width:"11",height:"12",viewBox:"0 0 11 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,A.jsx)("path",{d:"M5.49438 1L5.49438 11M5.49438 11L9.5 7M5.49438 11L1.5 7",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round",strokeLinejoin:"round"})}),of=({children:e,height:n,backgroundColor:t,mobileDirection:o})=>{let i=(0,I.useRef)(null),r=(0,I.useRef)(null),a=ou();return(0,I.useEffect)(()=>{let e=i.current;if(!e)return;e.scrollHeight>e.clientHeight&&r.current&&r.current.classList.remove("hide");let n=n=>{let{scrollTop:t,scrollHeight:o,clientHeight:i,scrollLeft:a,scrollWidth:s,clientWidth:c}=n.target;r.current&&t>0&&r.current.classList.add("hide"),0===t&&0===a?e.classList.add("scroll-start"):e.classList.remove("scroll-start"),o-t===i&&s-a===c?e.classList.add("scroll-end"):e.classList.remove("scroll-end")};return e.addEventListener("scroll",n),n({target:e}),()=>{e.removeEventListener("scroll",n)}},[i.current]),(0,A.jsxs)(og,{children:[(0,A.jsx)(oC,{ref:i,$mobile:a,$height:n,$backgroundColor:t,$mobileDirection:o,children:e}),(0,A.jsx)(ob,{ref:r,className:"hide",onClick:()=>{i.current&&i.current.scrollTo({top:i.current.scrollHeight,behavior:"smooth"})},children:(0,A.jsxs)("span",{children:[(0,A.jsx)(om,{})," More Available"]})})]})},ok=eL(W.P.div)`
  display: flex;
  gap: 8px;
  position: relative;
  border-radius: 9px;
...
`,ow=({children:e,error:n,icon:t})=>(0,A.jsxs)(ok,{$error:n,children:[t&&(0,A.jsx)(ov,{children:t}),(0,A.jsx)("div",{children:e})]});ow.displayName="Alert";let oy=()=>{let{storage:e}=(0,d.U)(),[n,t]=(0,I.useState)(null);return(0,I.useEffect)(()=>{(async()=>{let n=await (null==e?void 0:e.getItem("recentConnectorId"));t(null!=n?n:"")})()},[]),{lastConnectorId:n,updateLastConnectorId:n=>{null==e||e.setItem("recentConnectorId",n)}}},oj=()=>{var e;let n=rM(),t=ou(),o=n0(),{lastConnectorId:i}=oy(),r=n$(),a=nK(),s=o.filter(e=>e.id!==(null==a?void 0:a.id));r&&K()&&(s=s.filter(e=>e.id!==(null==r?void 0:r.id)));let c=(null==(e=n.options)?void 0:e.hideRecentBadge)||"walletConnect"===i?s:[...s.filter(e=>i===e.connector.id),...s.filter(e=>i!==e.connector.id)];return(0,A.jsxs)(of,{mobileDirection:"horizontal",children:[0===c.length&&(0,A.jsx)(ow,{error:!0,children:"No connectors found in ConnectKit config."}),c.length>0&&(0,A.jsx)(oa,{$mobile:t,$totalResults:c.length,children:c.map(e=>(0,A.jsx)(oS,{wallet:e,isRecent:e.id===i},e.id))})]})},oS=({wallet:e,isRecent:n})=>{var t,o,i,r;let{connect:{getUri:a}}=oh(),s=a(),c=ou(),l=rM(),{connect:d}=oc(),p=!e.isInstalled&&c||e.shouldDeeplinkDesktop&&!c?null==(t=e.getWalletConnectDeeplink)?void 0:t.call(e,null!=s?s:""):void 0,h=c&&ek(e.id),u=("safari"===eg()||"ios"===eg())&&ew(e.connector.id);return(h||u)&&(p=void 0),(0,A.jsxs)(on,{type:"button",as:p?"a":void 0,href:p||void 0,disabled:l.route!==rE.CONNECTORS,onClick:p?void 0:()=>{h?l.setRoute(rE.MOBILECONNECTORS):(u&&d({connector:null==e?void 0:e.connector}),l.setRoute(rE.CONNECT),l.setConnector({id:e.id}))},children:[(0,A.jsx)(oo,{"data-small":e.iconShouldShrink,"data-shape":e.iconShape,"data-background":h,children:null!=(o=e.iconConnector)?o:e.icon}),(0,A.jsxs)(ot,{children:[c&&null!=(i=e.shortName)?i:e.name,!(null==(r=l.options)?void 0:r.hideRecentBadge)&&n&&(0,A.jsx)(or,{children:(0,A.jsx)("span",{children:"Recent"})})]})]})},oN=eL(W.P.div)`
  display: flex;
  align-items: center;
  justify-content: center;
  inset: 0;
...
`,oz=eL.div`
  ...
  ${e=>e.$disabled&&(0,B.AH)`
    ...
    `}
`,oB=eL.div``;function oD(){let{log:e}=rM(),{connectAsync:n,connectors:t}=oc(),[o,i]=(0,I.useState)(!1);return{isOpen:o,open:async()=>{let o=document.createElement("style");o.innerHTML="w3m-modal, wcm-modal{ --wcm-z-index: 2147483647; --w3m-z-index:2147483647; }",document.head.appendChild(o);let r=t.find(e=>ek(e.id));if(r)try{let t=(await r.getProvider()).rpc.projectId,a=(0,G.u)({projectId:t,showQrModal:!0});i(!0);try{await n({connector:a})}catch(n){e("WalletConnect",n)}i(!1),document.head.removeChild(o)}catch(n){e("Could not get WalletConnect provider",n)}else e("No WalletConnect connector available")}}}let oR=eL(W.P.div)`
  ...
  ${e=>e.$clipboard?(0,B.AH)`
        ...
        `}
`,oH=({copied:e,small:n})=>(0,A.jsx)(oR,{$clipboard:e,children:(0,A.jsx)(nj,{style:{transform:n?"scale(1)":"translateX(3px) scale(1.5)",opacity:n||e?1:.3}})}),oU=eL.div`
...
`,oG=({string:e,children:n,variant:t})=>{let o,[i,r]=(0,I.useState)(!1),a=()=>{if(!e)return;let n=e.trim();navigator.clipboard&&navigator.clipboard.writeText(n),r(!0),clearTimeout(o),o=setTimeout(()=>r(!1),1e3)};return"button"===t?(0,A.jsx)(t_,{disabled:!e,onClick:a,icon:(0,A.jsx)(oH,{copied:i}),children:n}):(0,A.jsx)(oU,{onClick:a,$disabled:!e,children:(0,A.jsxs)(oZ,{children:[n,(0,A.jsx)(oH,{copied:i,small:!0})]})})},oP=(0,A.jsx)("svg",{width:"60",height:"60",viewBox:"0 0 60 60",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,A.jsx)("path",{d:"M30 42V19M19 30.5H42",stroke:"var(--ck-body-color-muted)",strokeWidth:"3",strokeLinecap:"round"})}),oV=()=>{var e,n;let t=rM(),o=nU(),{connect:{getUri:i}}=oh(),r=i(),{open:a,isOpen:s}=oD(),c=n0(),l=null!=(e=Object.keys(eS).filter(e=>{let n=eS[e];return!c.find(n=>n.connector.id===e)&&!!n.getWalletConnectDeeplink}))?e:[],d=e=>{var n;let t=null==(n=e.getWalletConnectDeeplink)?void 0:n.call(e,r);t&&(window.location.href=t)};return(0,A.jsx)(eX,{style:{width:312},children:(0,A.jsxs)(oB,{children:[(0,A.jsx)(e$,{style:{paddingBottom:0},children:(0,A.jsx)(of,{height:340,children:(0,A.jsxs)(oz,{$disabled:!r,children:[l.sort((e,n)=>{var t,o,i,r;let a=eS[e],s=eS[n],c=null!=(o=null!=(t=a.name)?t:a.shortName)?o:e,l=null!=(r=null!=(i=s.name)?i:s.shortName)?r:n;return c.localeCompare(l)}).filter(e=>"coinbaseWallet"!==e&&"com.coinbase.wallet"!==e).map((e,n)=>{let t=eS[e],{name:o,shortName:i,iconConnector:r,icon:a}=t;return(0,A.jsxs)(oF,{onClick:()=>d(t),style:{animationDelay:`${50*n}ms`},children:[(0,A.jsx)(oO,{$outline:!0,children:null!=r?r:a}),(0,A.jsx)(oW,{children:null!=i?i:o})]},n)}),(0,A.jsxs)(oF,{onClick:a,$waiting:s,children:[(0,A.jsx)(oO,{style:{background:"var(--ck-body-background-secondary)"},children:s?(0,A.jsx)("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center"},children:(0,A.jsx)("div",{style:{width:"50%"},children:(0,A.jsx)(tE,{})})}):oP}),(0,A.jsx)(oW,{children:o.more})]})]})})}),(null==(n=t.options)?void 0:n.walletConnectCTA)!=="modal"&&(0,A.jsx)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:14,paddingTop:8},children:(0,A.jsx)(oG,{variant:"button",string:r,children:o.copyToClipboard})})]})})},oY=eL(W.P.div)`
  display: flex;
  flex-direction: column;
  gap: 6px;
  position: relative;
...
`,o5=({children:e,message:n,open:t,xOffset:o=0,yOffset:i=0,delay:r})=>{var a;let s=rM(),c=nC();if(null==(a=s.options)?void 0:a.hideTooltips)return(0,A.jsx)(A.Fragment,{children:e});let[l,d]=(0,I.useState)(!1),[p,h]=(0,I.useState)(!1),[u,g]=(0,I.useState)("small"),[x,b]=(0,I.useState)(!1),[C]=(0,I.useState)(s.route),m=(0,I.useRef)(null),[f,k]=(0,U.A)({debounce:220*!x,offsetSize:!0,scroll:!0}),v=()=>{let e=!1,n=o+k.left+k.width,t=i+k.top+.5*k.height;return(n>window.innerWidth||n<0||t>window.innerHeight||t<0)&&(e=!0),e};return("undefined"!=typeof window?I.useLayoutEffect:I.useEffect)(()=>{if(!m.current||k.top+k.bottom+k.left+k.right+k.height+k.width===0)return;let e=o+k.left+k.width,n=i+k.top+.5*k.height;x||0===e||0===n||b(!0),m.current.style.left=`${e}px`,m.current.style.top=`${n}px`,g(m.current.offsetHeight<=40?"small":"large"),h(v())},[k,t,l]),(0,I.useEffect)(()=>{s.open||d(!1)},[s.open]),(0,I.useEffect)(()=>{d(!!t)},[t]),(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(W.P.div,{ref:f,style:void 0===t?{cursor:"help"}:{},onHoverStart:()=>d(!0),onHoverEnd:()=>d(!1),onClick:()=>d(!1),children:e}),(0,A.jsx)(eR,{children:(0,A.jsx)(T.N,{children:C===s.route&&!p&&l&&(0,A.jsx)(eD,{$useTheme:c.theme,$useMode:c.mode,$customTheme:c.customTheme,children:(0,A.jsx)(o0,{children:(0,A.jsxs)(o2,{role:"tooltip",$size:u,ref:m,initial:"collapsed",animate:x?"open":{},exit:"collapsed",variants:{collapsed:{transformOrigin:"20px 50%",opacity:0,scale:.9,z:.01,y:"-50%",x:20,transition:{duration:.1}},open:{willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:"-50%",x:20,transition:{ease:[.76,0,.24,1],duration:.15,delay:r||.5}}},children:[n,(0,A.jsx)(o3,{$size:u})]})})})})})]})},o4=eL(W.P.div)`
  z-index: 4;
  position: relative;
  overflow: hidden;
  svg {
...
`,ip=({logo:e,smallLogo:n,connecting:t=!0,unavailable:o=!1,countdown:i=!1})=>(0,A.jsxs)(ia,{transition:{duration:.5,ease:[.175,.885,.32,.98]},children:[(0,A.jsx)(is,{$small:!o&&n,style:o?{borderRadius:0}:void 0,children:e}),(0,A.jsx)(ic,{children:(0,A.jsxs)(T.N,{children:[t&&(0,A.jsx)(id,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,transition:{duration:+!!i}},children:(0,A.jsxs)("svg",{"aria-hidden":"true",width:"102",height:"102",viewBox:"0 0 102 102",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("path",{d:"M52 100C24.3858 100 2 77.6142 2 50",stroke:"url(#paint0_linear_1943_4139)",strokeWidth:"3.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,A.jsx)("defs",{children:(0,A.jsxs)("linearGradient",{id:"paint0_linear_1943_4139",x1:"2",y1:"48.5",x2:"53",y2:"100",gradientUnits:"userSpaceOnUse",children:[(0,A.jsx)("stop",{stopColor:"var(--ck-spinner-color)"}),(0,A.jsx)("stop",{offset:"1",stopColor:"var(--ck-spinner-color)",stopOpacity:"0"})]})})]})},"Spinner"),i&&(0,A.jsxs)(il,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.25},children:[(0,A.jsx)("div",{}),(0,A.jsx)("div",{})]},"ExpiringSpinner")]})})]}),ih={CONNECTED:"connected",CONNECTING:"connecting",EXPIRING:"expiring",FAILED:"failed",REJECTED:"rejected",NOTCONNECTED:"notconnected",UNAVAILABLE:"unavailable"},iu={initial:{willChange:"transform,opacity",position:"relative",opacity:0,scale:.95},animate:{position:"relative",opacity:1,scale:1,transition:{ease:[.16,1,.3,1],duration:.4,delay:.05,position:{delay:0}}},exit:{position:"absolute",opacity:0,scale:.95,transition:{ease:[.16,1,.3,1],duration:.3}}},ig=({switchConnectMethod:e,forceState:n})=>{var t,o,i,r,a,s,c,l;let d,{connect:p}=oc({mutation:{onMutate:e=>{e.connector?y(ih.CONNECTING):y(ih.UNAVAILABLE)},onError(e){console.error(e)},onSettled(e,n){if(n)if(m(!0),setTimeout(()=>m(!1),3500),n.code)switch(n.code){case -32002:y(ih.NOTCONNECTED);break;case 4001:y(ih.REJECTED);break;default:y(ih.FAILED)}else n.message&&("User rejected request"===n.message?y(ih.REJECTED):y(ih.FAILED));setTimeout(h,100)}}}),{triggerResize:h,connector:u}=rM(),g=u.id,x=n1(g),b={name:null==x?void 0:x.name,shortName:null!=(t=null==x?void 0:x.shortName)?t:null==x?void 0:x.name,icon:null!=(o=null==x?void 0:x.iconConnector)?o:null==x?void 0:x.icon,iconShape:null!=(i=null==x?void 0:x.iconShape)?i:"circle",iconShouldShrink:null==x?void 0:x.iconShouldShrink},[C,m]=(0,I.useState)(!1);(0,I.useState)(9);let f=eg(),k=null==(r=null==x?void 0:x.downloadUrls)?void 0:r[f],v=(null==x?void 0:x.downloadUrls)?{name:Object.keys(null==x?void 0:x.downloadUrls)[0],label:(null==(a=Object.keys(null==x?void 0:x.downloadUrls)[0])?void 0:a.charAt(0).toUpperCase())+(null==(s=Object.keys(null==x?void 0:x.downloadUrls)[0])?void 0:s.slice(1)),url:null==x?void 0:x.downloadUrls[Object.keys(null==x?void 0:x.downloadUrls)[0]]}:void 0,[w,y]=(0,I.useState)(n||((null==x?void 0:x.isInstalled)?ih.CONNECTING:ih.UNAVAILABLE)),j=nU({CONNECTORNAME:b.name,CONNECTORSHORTNAME:null!=(c=b.shortName)?c:b.name,SUGGESTEDEXTENSIONBROWSER:null!=(l=null==v?void 0:v.label)?l:"your browser"}),S=async()=>{(null==x?void 0:x.isInstalled)&&(null==x?void 0:x.connector)?p({connector:null==x?void 0:x.connector}):y(ih.UNAVAILABLE)};return((0,I.useEffect)(()=>{if(w!==ih.UNAVAILABLE)return d=setTimeout(S,600),()=>{clearTimeout(d)}},[]),x)?ek(null==x?void 0:x.connector.id)?(0,A.jsx)(eX,{children:(0,A.jsxs)(oJ,{children:[(0,A.jsx)(eq,{children:"Invalid State"}),(0,A.jsx)(e$,{children:(0,A.jsx)(ow,{children:"WalletConnect does not have an injection flow. This state should never happen."})})]})}):(0,A.jsx)(eX,{children:(0,A.jsxs)(oJ,{children:[(0,A.jsx)(oq,{children:(0,A.jsxs)(oK,{$shake:w===ih.FAILED||w===ih.REJECTED,$circle:"circle"===b.iconShape,children:[(0,A.jsx)(T.N,{children:(w===ih.FAILED||w===ih.REJECTED)&&(0,A.jsx)(o$,{"aria-label":"Retry",initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},whileTap:{scale:.9},transition:{duration:.1},onClick:S,children:(0,A.jsx)(o1,{children:(0,A.jsx)(o5,{open:C&&(w===ih.FAILED||w===ih.REJECTED),message:j.tryAgainQuestion,xOffset:-6,children:(0,A.jsx)(nw,{})})})})}),"circle"===b.iconShape?(0,A.jsx)(ip,{logo:w===ih.UNAVAILABLE?(0,A.jsx)("div",{style:{transform:"scale(1.14)",position:"relative",width:"100%"},children:b.icon}):(0,A.jsx)(A.Fragment,{children:b.icon}),smallLogo:b.iconShouldShrink,connecting:w===ih.CONNECTING,unavailable:w===ih.UNAVAILABLE}):(0,A.jsx)(o7,{logo:w===ih.UNAVAILABLE?(0,A.jsx)("div",{style:{transform:"scale(1.14)",position:"relative",width:"100%"},children:b.icon}):(0,A.jsx)(A.Fragment,{children:b.icon}),connecting:w===ih.CONNECTING})]})}),(0,A.jsx)(eK,{children:(0,A.jsxs)(T.N,{initial:!1,children:[w===ih.FAILED&&(0,A.jsxs)(oY,{initial:"initial",animate:"animate",exit:"exit",variants:iu,children:[(0,A.jsxs)(e$,{children:[(0,A.jsxs)(e1,{$error:!0,children:[(0,A.jsx)(nf,{}),j.injectionScreen_failed_h1]}),(0,A.jsx)(e0,{children:j.injectionScreen_failed_p})]}),ev(x.id)&&(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(n7,{}),(0,A.jsx)(t_,{onClick:()=>e(g),children:j.connectWithFamilyIOS})]})]},ih.FAILED),w===ih.REJECTED&&(0,A.jsxs)(oY,{initial:"initial",animate:"animate",exit:"exit",variants:iu,children:[(0,A.jsxs)(e$,{style:ev(x.connector.id)?{paddingBottom:12}:{paddingBottom:28},children:[(0,A.jsx)(e1,{children:j.injectionScreen_rejected_h1}),(0,A.jsx)(e0,{children:j.injectionScreen_rejected_p})]}),ev(x.id)&&(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(n7,{}),(0,A.jsx)(t_,{onClick:()=>e(g),children:j.connectWithFamilyIOS})]})]},ih.REJECTED),(w===ih.CONNECTING||w===ih.EXPIRING)&&(0,A.jsx)(oY,{initial:"initial",animate:"animate",exit:"exit",variants:iu,children:(0,A.jsxs)(e$,{style:{paddingBottom:28},children:[(0,A.jsx)(e1,{children:"injected"===x.connector.id?j.injectionScreen_connecting_injected_h1:j.injectionScreen_connecting_h1}),(0,A.jsx)(e0,{children:"injected"===x.connector.id?j.injectionScreen_connecting_injected_p:j.injectionScreen_connecting_p})]})},ih.CONNECTING),w===ih.CONNECTED&&(0,A.jsx)(oY,{initial:"initial",animate:"animate",exit:"exit",variants:iu,children:(0,A.jsxs)(e$,{children:[(0,A.jsxs)(e1,{$valid:!0,children:[(0,A.jsx)(nv,{})," ",j.injectionScreen_connected_h1]}),(0,A.jsx)(e0,{children:j.injectionScreen_connected_p})]})},ih.CONNECTED),w===ih.NOTCONNECTED&&(0,A.jsx)(oY,{initial:"initial",animate:"animate",exit:"exit",variants:iu,children:(0,A.jsxs)(e$,{children:[(0,A.jsx)(e1,{children:j.injectionScreen_notconnected_h1}),(0,A.jsx)(e0,{children:j.injectionScreen_notconnected_p})]})},ih.NOTCONNECTED),w===ih.UNAVAILABLE&&(0,A.jsx)(oY,{initial:"initial",animate:"animate",exit:"exit",variants:iu,children:k?(0,A.jsxs)(A.Fragment,{children:[(0,A.jsxs)(e$,{style:{paddingBottom:18},children:[(0,A.jsx)(e1,{children:j.injectionScreen_install_h1}),(0,A.jsx)(e0,{children:j.injectionScreen_install_p})]}),!x.isInstalled&&k&&(0,A.jsx)(t_,{href:k,icon:(0,A.jsx)(ir,{}),children:j.installTheExtension})]}):(0,A.jsxs)(A.Fragment,{children:[(0,A.jsxs)(e$,{style:{paddingBottom:12},children:[(0,A.jsx)(e1,{children:j.injectionScreen_unavailable_h1}),(0,A.jsx)(e0,{children:j.injectionScreen_unavailable_p})]}),!x.isInstalled&&v&&(0,A.jsxs)(t_,{href:null==v?void 0:v.url,icon:(0,A.jsx)(ir,{browser:null==v?void 0:v.name}),children:["Install on ",null==v?void 0:v.label]})]})},ih.UNAVAILABLE)]})})]})}):(0,A.jsx)(eX,{children:(0,A.jsxs)(oJ,{children:[(0,A.jsx)(eq,{children:"Invalid State"}),(0,A.jsx)(e$,{children:(0,A.jsx)(ow,{children:"No connectors match the id given. This state should never happen."})})]})})},ix=eL(W.P.div)`
  z-index: 3;
  position: relative;
  overflow: hidden;
  height: 0;
...
`,iv=eL(W.P.div)`
  ...
  ${e=>e.$wcLogo?(0,B.AH)`
        ...
        `}
`,iw=(e,n)=>{let t=Array.prototype.slice.call(P.create(e,{errorCorrectionLevel:n}).modules.data,0),o=Math.sqrt(t.length);return t.reduce((e,n,t)=>(t%o==0?e.push([n]):e[e.length-1].push(n))&&e,[])};function iy({ecl:e="M",size:n=200,uri:t,clearArea:o=!1,image:i,imageBackground:r="transparent"}){let a=76*!!o,s=n-20,c=(0,I.useMemo)(()=>{let n=[],o=iw(t,e),c=s/o.length;if([{x:0,y:0},{x:1,y:0},{x:0,y:1}].forEach(({x:e,y:t})=>{let i=(o.length-7)*c*e,r=(o.length-7)*c*t;for(let o=0;o<3;o++)n.push((0,A.jsx)("rect",{fill:o%2!=0?"var(--ck-qr-background, var(--ck-body-background))":"var(--ck-qr-dot-color)",rx:-((o-2)*5)+(0===o?2:3),ry:-((o-2)*5)+(0===o?2:3),width:c*(7-2*o),height:c*(7-2*o),x:i+c*o,y:r+c*o},`${o}-${e}-${t}`))}),i){let e=(o.length-7)*c*1,t=(o.length-7)*c*1;n.push((0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)("rect",{fill:r,rx:12,ry:12,width:7*c,height:7*c,x:e+0*c,y:t+0*c}),(0,A.jsx)("foreignObject",{width:7*c,height:7*c,x:e+0*c,y:t+0*c,children:(0,A.jsx)("div",{style:{borderRadius:12,overflow:"hidden"},children:i})})]}))}let l=Math.floor((a+25)/c),d=o.length/2-l/2,p=o.length/2+l/2-1;return o.forEach((e,t)=>{e.forEach((e,r)=>{o[t][r]&&!(t<7&&r<7||t>o.length-8&&r<7||t<7&&r>o.length-8)&&(i||!(t>d&&t<p&&r>d&&r<p))&&n.push((0,A.jsx)("circle",{cx:t*c+c/2,cy:r*c+c/2,fill:"var(--ck-qr-dot-color)",r:c/3},`circle-${t}-${r}`))})}),n},[e,s,t]);return(0,A.jsxs)("svg",{height:s,width:s,viewBox:`0 0 ${s} ${s}`,style:{width:s,height:s},children:[(0,A.jsx)("rect",{fill:"transparent",height:s,width:s}),c]})}function ij({value:e,image:n,imageBackground:t,imagePosition:o="center",tooltipMessage:i}){let r=function(){let[e,n]=(0,I.useState)({width:0,height:0});return(0,I.useEffect)(()=>{function e(){n({width:window.innerWidth,height:window.innerHeight})}return window.addEventListener("resize",e),e(),()=>window.removeEventListener("resize",e)},[]),e}().width>920&&i?(0,A.jsx)(o5,{xOffset:139,yOffset:5,delay:.1,message:i,children:n}):n;return(0,A.jsx)(ix,{children:(0,A.jsxs)(ib,{children:[n&&(0,A.jsx)(ik,{children:(0,A.jsx)(iv,{$wcLogo:"center"!==o,style:{background:"center"===o?t:void 0},children:r})}),(0,A.jsx)(T.N,{initial:!1,children:e?(0,A.jsx)(W.P.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},children:(0,A.jsx)(iy,{uri:e,size:288,ecl:"M",clearArea:!!("center"===o&&n)})},e):(0,A.jsxs)(im,{initial:{opacity:.1},animate:{opacity:.1},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},children:[(0,A.jsx)("span",{}),(0,A.jsx)("span",{}),(0,A.jsx)("span",{}),(0,A.jsx)("div",{})]})})]})})}ij.displayName="CustomQRCode";let iS=eL(W.P.div)`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,iN=({logo:e})=>{let n=[(0,A.jsx)(el.MetaMask,{background:!0}),(0,A.jsx)(el.Coinbase,{background:!0}),(0,A.jsx)(el.Crypto,{}),(0,A.jsx)(el.ImToken,{}),(0,A.jsx)(el.Argent,{}),(0,A.jsx)(el.Trust,{})];return(0,A.jsx)(iS,{children:(0,A.jsxs)("svg",{"aria-hidden":"true",width:"47",height:"52",viewBox:"0 0 47 52",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsxs)("g",{mask:"url(#gradient-mask)",children:[(0,A.jsx)("path",{d:"M7 14.5C7 11.4624 9.46243 9 12.5 9H31.5C34.5376 9 37 11.4624 37 14.5V47H7V14.5Z",fill:"var(--ck-graphic-scaniconwithlogos-04)"}),e?(0,A.jsx)("foreignObject",{x:"13",y:"21",width:"18",height:"18",rx:"5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:5},children:e})}):(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)("foreignObject",{x:"12",y:"15",width:"9",height:"9",rx:"2.5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[0]})}),(0,A.jsx)("foreignObject",{x:"23",y:"15",width:"9",height:"9",rx:"2.5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[1]})}),(0,A.jsx)("foreignObject",{x:"12",y:"26",width:"9",height:"9",rx:"2.5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[2]})})}),(0,A.jsx)("foreignObject",{x:"23",y:"26",width:"9",height:"9",rx:"2.5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[3]})}),(0,A.jsx)("foreignObject",{x:"12",y:"37",width:"9",height:"9",rx:"2.5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[4]})}),(0,A.jsx)("foreignObject",{x:"23",y:"37",width:"9",height:"9",rx:"2.5",children:(0,A.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[5]})})]}),(0,A.jsx)("path",{d:"M36 47V13.7143C36 11.1107 33.8893 9 31.2857 9H12.7143C10.1107 9 8 11.1107 8 13.7143V47",stroke:"url(#paint0_linear_924_12568)",strokeWidth:"2"}),(0,A.jsx)("path",{d:"M15 10H29C29 11.1046 28.1046 12 27 12H17C15.8954 12 15 11.1046 15 10Z",fill:"var(--ck-graphic-scaniconwithlogos-01)"}),(0,A.jsx)("rect",{x:"1",y:"47",width:"43",height:"5",fill:"var(--ck-tooltip-background)"}),(0,A.jsx)("rect",{x:"22",y:"1",width:"24",height:"24",rx:"12",fill:"var(--ck-graphic-scaniconwithlogos-03)",stroke:"var(--ck-tooltip-background)",strokeWidth:"2"}),(0,A.jsx)("rect",{x:"34.5",y:"10",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,A.jsx)("rect",{x:"31",y:"10",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,A.jsx)("rect",{x:"31",y:"13.5",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,A.jsx)("rect",{x:"34.5",y:"13.5",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,A.jsx)("path",{d:"M28.5 10.5V9C28.5 8.17157 29.1716 7.5 30 7.5H31.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,A.jsx)("path",{d:"M36.5 7.5L38 7.5C38.8284 7.5 39.5 8.17157 39.5 9L39.5 10.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,A.jsx)("path",{d:"M39.5 15.5L39.5 17C39.5 17.8284 38.8284 18.5 38 18.5L36.5 18.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,A.jsx)("path",{d:"M31.5 18.5L30 18.5C29.1716 18.5 28.5 17.8284 28.5 17L28.5 15.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})]}),(0,A.jsxs)("defs",{children:[(0,A.jsxs)("linearGradient",{id:"paint0_linear_924_12568",x1:"22",y1:"8.2549",x2:"22",y2:"47",gradientUnits:"userSpaceOnUse",children:[(0,A.jsx)("stop",{stopColor:"var(--ck-graphic-scaniconwithlogos-01)"}),(0,A.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-scaniconwithlogos-02)"})]}),(0,A.jsxs)("linearGradient",{id:"linear-gradient-mask",x1:"47",y1:"42",x2:"47",y2:"47",gradientUnits:"userSpaceOnUse",children:[(0,A.jsx)("stop",{stopColor:"white"}),(0,A.jsx)("stop",{offset:"1",stopColor:"black",stopOpacity:"0"})]}),(0,A.jsx)("mask",{id:"gradient-mask",children:(0,A.jsx)("rect",{x:"0",y:"0",width:"47",height:"52",fill:"url(#linear-gradient-mask)"})})]})]})})},iE=({switchConnectMethod:e})=>{var n,t,o,i,r,a,s,c;let l=rM(),d=l.connector.id,p=n1(l.connector.id),{open:h,isOpen:u}=oD(),{connect:{getUri:g}}=oh(),x=g(d),b=x?null!=(t=null==(n=null==p?void 0:p.getWalletConnectDeeplink)?void 0:n.call(p,x))?t:x:void 0,C=nU({CONNECTORNAME:null==p?void 0:p.name});if(!p)return(0,A.jsxs)(A.Fragment,{children:["Wallet not found ",l.connector.id]});let m=null==p?void 0:p.downloadUrls,f={chrome:null==m?void 0:m.chrome,firefox:null==m?void 0:m.firefox,brave:null==m?void 0:m.brave,edge:null==m?void 0:m.edge,safari:null==m?void 0:m.safari};eg();let k=m&&0!==Object.keys(m).length;f&&(Object.keys(f)[0],null==(o=Object.keys(f)[0])||o.charAt(0).toUpperCase(),null==(i=Object.keys(f)[0])||i.slice(1),f[Object.keys(f)[0]]);let v=ek(d);return(0,A.jsxs)(eX,{children:[(0,A.jsxs)(e$,{style:{paddingBottom:8,gap:14},children:[(0,A.jsx)(ij,{value:b,image:null==p?void 0:p.icon,tooltipMessage:ek(d)?(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(iN,{}),(0,A.jsx)("span",{children:C.scanScreen_tooltip_walletConnect})]}):(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(iN,{logo:null==p?void 0:p.icon}),(0,A.jsx)("span",{children:C.scanScreen_tooltip_default})]})}),v?(0,A.jsx)(n7,{}):k&&(0,A.jsx)(n7,{children:C.dontHaveTheApp})]}),v&&(0,A.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:14},children:[(null==(r=l.options)?void 0:r.walletConnectCTA)!=="modal"&&(0,A.jsx)(oG,{variant:"button",string:b,children:(null==(a=l.options)?void 0:a.walletConnectCTA)==="link"?C.copyToClipboard:C.copyCode}),(null==(s=l.options)?void 0:s.walletConnectCTA)!=="link"&&(0,A.jsx)(t_,{icon:(0,A.jsx)(nm,{}),onClick:h,disabled:u,waiting:u,children:(null==(c=l.options)?void 0:c.walletConnectCTA)==="modal"?C.useWalletConnectModal:C.useModal})]}),ev(p.id)&&(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(n7,{}),(0,A.jsx)(t_,{onClick:()=>e(d),children:C.loginWithEmailOrPhone})]}),k&&(0,A.jsx)(A.Fragment,{children:(0,A.jsx)(t_,{onClick:()=>{l.setRoute(rE.DOWNLOAD)},download:!0,children:C.getWalletName})})]})},iL={QRCODE:"qrcode",INJECTOR:"injector"},i_=()=>{let e=rM(),n=n1(e.connector.id),t=!(null==n?void 0:n.isInstalled)&&(null==n?void 0:n.getWalletConnectDeeplink),[o,i]=(0,I.useState)(t?iL.QRCODE:iL.INJECTOR);return((0,I.useEffect)(()=>{let t=async()=>{await (null==n?void 0:n.connector.getProvider())||(i(iL.QRCODE),setTimeout(e.triggerResize,10))};o===iL.INJECTOR&&t()},[]),n)?(0,A.jsxs)(T.N,{children:[o===iL.QRCODE&&(0,A.jsx)(W.P.div,{initial:"initial",animate:"animate",exit:"exit",variants:n9,children:(0,A.jsx)(iE,{switchConnectMethod:n=>{i(iL.INJECTOR),setTimeout(e.triggerResize,10)}})},iL.QRCODE),o===iL.INJECTOR&&(0,A.jsx)(W.P.div,{initial:"initial",animate:"animate",exit:"exit",variants:n9,children:(0,A.jsx)(ig,{switchConnectMethod:n=>{i(iL.QRCODE),setTimeout(e.triggerResize,10)}})},iL.INJECTOR)]}):(0,A.jsxs)(ow,{children:["Connector not found ",e.connector.id]})},iM=()=>{var e,n,t;let o=n1(rM().connector.id),i=nU({CONNECTORNAME:null==o?void 0:o.name});if(!o)return(0,A.jsx)(A.Fragment,{children:"Wallet not found"});let r={ios:null==(e=o.downloadUrls)?void 0:e.ios,android:null==(n=o.downloadUrls)?void 0:n.android,redirect:null==(t=o.downloadUrls)?void 0:t.download},a=r.ios&&r.android?i.downloadAppScreen_iosAndroid:r.ios?i.downloadAppScreen_ios:i.downloadAppScreen_android;return(0,A.jsx)(eX,{children:(0,A.jsxs)(e$,{style:{paddingBottom:4,gap:14},children:[r.redirect&&(0,A.jsx)(ij,{value:r.redirect}),!r.redirect&&(0,A.jsx)(A.Fragment,{children:"No download link available"}),(0,A.jsx)(e0,{style:{fontSize:15,lineHeight:"20px",padding:"0 12px"},children:a})]})})},iA=eL(W.P.div)`
  padding: 18px 0 20px;
  @media only screen and (max-width: ${eH.mobileWidth}px) {
    padding: 16px 0 20px;
  }
...
`,i2=(0,A.jsxs)("svg",{"aria-hidden":"true",width:"36",height:"36",viewBox:"0 0 36 36",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M2 16.75C2.69036 16.75 3.25 17.3096 3.25 18V19C3.25 26.5939 9.40609 32.75 17 32.75V35.25C8.02537 35.25 0.75 27.9746 0.75 19V18C0.75 17.3096 1.30964 16.75 2 16.75Z",fill:"url(#paint0_linear_1288_18701)"}),(0,A.jsx)("defs",{children:(0,A.jsxs)("linearGradient",{id:"paint0_linear_1288_18701",x1:"2",y1:"19.4884",x2:"16.8752",y2:"33.7485",gradientUnits:"userSpaceOnUse",children:[(0,A.jsx)("stop",{stopColor:"var(--ck-spinner-color)"}),(0,A.jsx)("stop",{offset:"1",stopColor:"var(--ck-spinner-color)",stopOpacity:"0"})]})})]}),i3=({variant:e})=>{let{connector:n,chain:t}=(0,c.F)(),{chains:o,isPending:i,switchChain:r,error:a}=(0,l.R)(),[s,d]=(0,I.useState)(void 0),p=nU({}),h=em(),u=(null==a?void 0:a.code)===4902,g=u||!r,x=e=>{r&&(d(e),r({chainId:e}))},{triggerResize:b}=rM();return(0,A.jsxs)(iY,{style:{marginBottom:void 0!==r?-8:0},children:[(0,A.jsx)(iq,{children:(0,A.jsx)(iK,{children:o.map(o=>{var r;let a={...iV.find(e=>e.id===o.id),...o};return(0,A.jsxs)(i$,{$variant:e,disabled:g||a.id===(null==t?void 0:t.id)||i&&s===a.id,onClick:()=>null==x?void 0:x(a.id),style:{opacity:g&&a.id!==(null==t?void 0:t.id)?.4:void 0},children:[(0,A.jsxs)("span",{style:{display:"flex",alignItems:"center",justifyContent:"flex-start",gap:12,color:a.id===(null==t?void 0:t.id)?"var(--ck-dropdown-active-color, inherit)":"inherit"},children:[(0,A.jsxs)(iX,{children:[(0,A.jsx)(iJ,{initial:{opacity:0},animate:{opacity:i&&s===a.id?1:0},transition:{ease:[.76,0,.24,1],duration:.15,delay:.1},children:(0,A.jsx)(W.P.div,{animate:h&&ew(null==n?void 0:n.id)&&i&&s===a.id?{opacity:[1,0],transition:{delay:4,duration:3}}:{opacity:1},children:i2},`${null==a?void 0:a.id}-${null==a?void 0:a.name}`)}),(0,A.jsx)(iQ,{children:null!=(r=a.logo)?r:(0,A.jsx)(iP.UnknownChain,{})})]}),a.name]}),"secondary"!==e&&(0,A.jsx)(i1,{children:(0,A.jsxs)(T.N,{initial:!1,exitBeforeEnter:!0,children:[a.id===(null==t?void 0:t.id)&&(0,A.jsx)(W.P.span,{style:{color:"var(--ck-dropdown-active-color, var(--ck-focus-color))",display:"block",position:"relative"},initial:{opacity:0,x:-4},animate:{opacity:1,x:0},exit:{opacity:0,x:4,transition:{duration:.1,delay:0}},transition:{ease:[.76,0,.24,1],duration:.3,delay:.2},children:p.connected},"connectedText"),i&&s===a.id&&(0,A.jsx)(W.P.span,{style:{color:"var(--ck-dropdown-pending-color, inherit)",display:"block",position:"relative"},initial:{opacity:0,x:-4},animate:{opacity:1,x:0},exit:{opacity:0,x:4},transition:{ease:[.76,0,.24,1],duration:.3,delay:.1},children:(0,A.jsx)(W.P.span,{animate:h&&ew(null==n?void 0:n.id)&&{opacity:[1,0],transition:{delay:4,duration:4}},children:p.approveInWallet})},"approveText")]})}),"secondary"===e?(0,A.jsx)(i0,{initial:!1,animate:{opacity:+(a.id===(null==t?void 0:t.id))},transition:{duration:.3,ease:"easeOut"}}):a.id===(null==t?void 0:t.id)&&(0,A.jsx)(i0,{layoutId:"activeChain",layout:"position",transition:{duration:.3,ease:"easeOut"}})]},`${null==a?void 0:a.id}-${null==a?void 0:a.name}`)})})}),(0,A.jsx)(T.N,{children:u&&(0,A.jsx)(W.P.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{ease:[.76,0,.24,1],duration:.3},onAnimationStart:b,onAnimationComplete:b,children:(0,A.jsx)("div",{style:{paddingTop:10,paddingBottom:8},children:(0,A.jsxs)(ow,{children:[p.warnings_walletSwitchingUnsupported," ",p.warnings_walletSwitchingUnsupportedResolve]})})})})]})},i5=eL(W.P.div)`
  z-index: 2147483647;
  position: fixed;
  inset: 0;
`,i4=eL(W.P.div)`
...
`,i8=eL(W.P.div)`
  ...
  user-select: none;
  color: var(--ck-dropdown-color, var(--ck-tooltip-color));
`,i6=({children:e,open:n,onClose:t,offsetX:o=0,offsetY:i=8})=>{var r,a,s;let c=rM(),l=nC(),d=nU(),[p,h]=(0,I.useState)({x:0,y:0});nh(n);let u=(0,I.useRef)(null);(0,I.useEffect)(()=>{let e=e=>{var o,i,r;if(n&&("Escape"===e.key&&t(),"ArrowDown"===e.key||"ArrowUp"===e.key)){if(!u.current)return;e.preventDefault();let n=null==(o=u.current)?void 0:o.querySelectorAll(`
            a[href]:not(:disabled),
            button:not(:disabled),
            textarea:not(:disabled),
            input[type="text"]:not(:disabled),
            ...
            input[type="checkbox"]:not(:disabled),
            select:not(:disabled)
          `),t=n[0],a=n[n.length-1];if("ArrowUp"===e.key)if(document.activeElement===t)a.focus();else{let e=null==(i=null==document?void 0:document.activeElement)?void 0:i.previousSibling;for(e||(e=a);e.disabled;)e=e.previousSibling;e.focus()}else if(document.activeElement===a)t.focus();else{let e=null==(r=null==document?void 0:document.activeElement)?void 0:r.nextSibling;for(e||(e=t);e.disabled;)e=e.nextSibling;e.focus()}}};return document.addEventListener("keydown",e),()=>{document.removeEventListener("keydown",e)}},[n]);let g=(0,I.useRef)(null),x=(0,I.useCallback)(e=>{e&&(g.current=e,m())},[n]),[b,C]=(0,U.A)({debounce:120,offsetSize:!0,scroll:!0}),m=()=>{if(!g.current||C.top+C.bottom+C.left+C.right+C.height+C.width===0)return;let e=C.left+o,n=C.top+C.height+i;g.current.style.left=`${e}px`,g.current.style.top=`${n}px`};return("undefined"!=typeof window?I.useLayoutEffect:I.useEffect)(m,[g.current,C,n]),(0,I.useEffect)(m,[n,g.current]),(0,I.useEffect)(()=>(m(),window.addEventListener("scroll",t),window.addEventListener("resize",t),()=>{window.removeEventListener("scroll",t),window.removeEventListener("resize",t)}),[]),(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)("div",{ref:b,children:e}),(0,A.jsx)(T.N,{children:n&&(0,A.jsx)(eR,{children:(0,A.jsx)(eD,{$useTheme:null!=(r=l.theme)?r:c.theme,$useMode:null!=(a=l.mode)?a:c.mode,$customTheme:null!=(s=l.customTheme)?s:c.customTheme,children:(0,A.jsx)(nu,{children:(0,A.jsxs)(i5,{ref:u,children:[(0,A.jsx)(i4,{onClick:t}),(0,A.jsxs)(i9,{ref:x,style:{left:p.x,top:p.y},initial:"collapsed",animate:"open",exit:"collapsed",variants:{collapsed:{transformOrigin:"0 0",opacity:0,scale:.96,z:.01,y:-4,x:0,transition:{duration:.1}},open:{transformOrigin:"0 0",willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:0,x:0,transition:{ease:[.76,0,.24,1],duration:.15}}},children:[(0,A.jsx)(i8,{children:d.switchNetworks}),(0,A.jsx)(i3,{})]})]})})})})})]})},i7=eL.div`
  --bg: transparent;
  --color: #333;
...
`,ri=(0,A.jsxs)("svg",{"aria-hidden":"true",width:"36",height:"36",viewBox:"0 0 36 36",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.3592 30.1654C10.0472 29.4491 8.85718 28.524 7.83713 27.424C6.81708 26.324 5.98425 25.0677 5.36889 23.7054C5.20157 23.335 5.05033 22.9567 4.91578 22.5717C4.51465 21.4237 4.26735 20.2308 4.17794 19.0239C4.16599 18.8626 4.13894 18.7041 4.09809 18.5507C3.85023 17.6197 3.09399 16.8738 2.11531 16.7999C0.975331 16.7138 -0.0310983 17.5702 0.0141657 18.7125C0.0223289 18.9185 0.0340286 19.1243 0.049253 19.3298C0.165374 20.8971 0.486545 22.4464 1.00749 23.9373C1.10424 24.2142 1.20764 24.4884 1.31755 24.7596C2.13617 26.7799 3.31595 28.6371 4.80146 30.239C6.28696 31.841 8.04998 33.1573 10.0029 34.1258C10.2651 34.2558 10.5307 34.3796 10.7995 34.4969C12.247 35.1287 13.7676 35.5656 15.3217 35.7995C15.5255 35.8301 15.7298 35.8573 15.9346 35.881C17.0703 36.0122 18.0001 35.0731 18.0001 33.9299C18.0001 32.9484 17.3133 32.1381 16.4036 31.8208C16.2537 31.7685 16.0977 31.7296 15.9377 31.7056C14.7411 31.5255 13.5702 31.1891 12.4556 30.7026C12.0818 30.5394 11.716 30.3601 11.3592 30.1654Z",fill:"url(#paint0_linear_1288_1870)"}),(0,A.jsx)("defs",{children:(0,A.jsxs)("linearGradient",{id:"paint0_linear_1288_1870",x1:"2",y1:"19.4884",x2:"16.8752",y2:"33.7485",gradientUnits:"userSpaceOnUse",children:[(0,A.jsx)("stop",{stopColor:"var(--ck-connectbutton-balance-color,currentColor)",stopOpacity:"0.7"}),(0,A.jsx)("stop",{offset:"1",stopColor:"var(--ck-connectbutton-balance-color,currentColor)",stopOpacity:"0"})]})})]}),rr=({id:e,unsupported:n,radius:t="50%",size:o=24})=>{var i;let r=ol(e),a=iV.find(n=>n.id===e);return iR()?(0,A.jsx)(i7,{size:o,radius:t,children:(0,A.jsxs)(T.N,{initial:!1,children:[(null!=n?n:!r)&&(0,A.jsx)(ro,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,A.jsxs)("svg",{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,A.jsx)("path",{d:"M2.61317 11.2501H9.46246C10.6009 11.2501 11.3256 10.3506 11.3256 9.3549C11.3256 9.05145 11.255 8.73244 11.0881 8.43303L7.65903 2.14708C7.659 2.14702 7.65897 2.14696 7.65893 2.1469C7.65889 2.14682 7.65884 2.14673 7.65879 2.14664C7.31045 1.50746 6.6741 1.17871 6.04 1.17871C5.41478 1.17871 4.763 1.50043 4.41518 2.14968L0.993416 8.43476C0.828865 8.72426 0.75 9.04297 0.75 9.3549C0.75 10.3506 1.47471 11.2501 2.61317 11.2501Z",fill:"currentColor",stroke:"var(--ck-body-background, #fff)",strokeWidth:"1.5"}),(0,A.jsx)("path",{d:"M6.03258 7.43916C5.77502 7.43916 5.63096 7.29153 5.62223 7.02311L5.55675 4.96973C5.54802 4.69684 5.74446 4.5 6.02821 4.5C6.3076 4.5 6.51277 4.70131 6.50404 4.9742L6.43856 7.01864C6.42546 7.29153 6.2814 7.43916 6.03258 7.43916ZM6.03258 9.11676C5.7401 9.11676 5.5 8.9065 5.5 8.60677C5.5 8.30704 5.7401 8.09678 6.03258 8.09678C6.32506 8.09678 6.56515 8.30256 6.56515 8.60677C6.56515 8.91097 6.32069 9.11676 6.03258 9.11676Z",fill:"white"})]})}),e?(0,A.jsx)(re,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:null!=(i=null==a?void 0:a.logo)?i:(0,A.jsx)(iP.UnknownChain,{})},`${null==a?void 0:a.id}-${null==a?void 0:a.name}-${e}`):(0,A.jsx)(rt,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:ri},"loading")]})}):(0,A.jsx)("div",{style:{width:o,height:o}})},ra=eL(W.P.div)``,rs=eL(W.P.button)`
  ...
  ${e=>e.disabled?(0,B.AH)`
        ...
        `}
`,rc=({...e})=>(0,A.jsx)("svg",{"aria-hidden":"true",width:"11",height:"6",viewBox:"0 0 11 6",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,A.jsx)("path",{d:"M1.5 1L5.5 5L9.5 1",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),rl=()=>{let e=rM(),[n,t]=(0,I.useState)(!1),{chain:o}=(0,c.F)(),{chains:i}=(0,l.R)(),r=nU({CHAIN:null==o?void 0:o.name}),a=em()||(null==window?void 0:window.innerWidth)<eH.mobileWidth;(0,I.useEffect)(()=>{e.open||t(!1)},[e.open]);let s=i.length<=1;return(0,A.jsx)(A.Fragment,{children:(0,A.jsx)(ra,{children:(0,A.jsx)(i6,{offsetX:-12,open:!a&&n,onClose:()=>t(!1),children:(0,A.jsxs)(rs,{"aria-label":ef(r.switchNetworks).toString(),disabled:s,onClick:()=>{a?e.setRoute(rE.SWITCHNETWORKS):t(!n)},children:[s?(0,A.jsx)(o5,{message:r.chainNetwork,xOffset:-6,delay:.01,children:(0,A.jsx)(rr,{id:null==o?void 0:o.id})}):(0,A.jsx)(rr,{id:null==o?void 0:o.id}),!s&&(0,A.jsx)(rc,{style:{top:1,left:-3}})]})})})})},rd=({closeModal:e})=>{var n,t,o;let i=rM(),r=nC(),a=nU(),{reset:s}=(0,p.e)(),{disconnect:l}=(0,b.u)(),{address:d,isConnected:h,connector:u,chain:x}=(0,c.F)(),f=ev(null==u?void 0:u.id),{data:k}=(0,C.Q)({connector:u}),v=iU(),{data:w}=(0,g.v)({chainId:1,address:d,config:v}),{data:y}=(0,m.A)({address:d}),[j,S]=(0,I.useState)(!1);(0,I.useEffect)(()=>{h||i.setOpen(!1)},[h]),(0,I.useEffect)(()=>{if(j)return e?e():i.setOpen(!1),()=>{l(),s()}},[j,l,s]);let N=["web95","rounded","minimal"].includes(null!=(t=null!=(n=r.theme)?n:i.theme)?t:"")?"....":void 0;return(0,A.jsxs)(eX,{children:[(0,A.jsxs)(e$,{style:{paddingBottom:22,gap:6},children:[(0,A.jsx)(iA,{children:(0,A.jsxs)(iI,{children:[(0,A.jsx)(iF,{children:(0,A.jsx)(rl,{})}),(0,A.jsx)(iZ,{address:d})]})}),(0,A.jsx)(e1,{children:(0,A.jsx)(oG,{string:d,children:null!=w?w:ep(d,N)})}),(null==(o=null==i?void 0:i.options)?void 0:o.hideBalance)?null:(0,A.jsx)(e0,{children:(0,A.jsx)(iO,{children:(0,A.jsxs)(T.N,{exitBeforeEnter:!0,initial:!1,children:[y&&(0,A.jsxs)(iW,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:[eu(Number(null==y?void 0:y.formatted))," ",null==y?void 0:y.symbol]},`chain-${null==x?void 0:x.id}`),!y&&(0,A.jsx)(iz,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:"\xa0"})]})})})]}),f&&(0,A.jsx)(A.Fragment,{children:(0,A.jsx)(t_,{onClick:async()=>{try{await (null==k?void 0:k.request({method:"family_switchAccounts",params:[]}))}catch(e){i.log("rpc method family_switchAccounts is not implemented in this connector",e)}},children:a.switchWallets})}),!ey(null==u?void 0:u.id)&&(0,A.jsx)(t_,{onClick:()=>S(!0),icon:f?void 0:(0,A.jsx)(nk,{}),children:a.disconnect})]})},rp=()=>{let{reset:e}=(0,p.e)(),{disconnect:n}=(0,b.u)(),{connector:t,chain:o}=(0,c.F)(),i=ol(null==o?void 0:o.id),r=nU({});return(0,A.jsx)(eX,{style:{width:278},children:(0,A.jsxs)(e$,{style:{padding:0,marginTop:-10},children:[!i&&(0,A.jsxs)(e0,{children:[r.warnings_chainUnsupported," ",r.warnings_chainUnsupportedResolve]}),(0,A.jsx)("div",{style:{padding:"6px 8px"},children:(0,A.jsx)(i3,{variant:"secondary"})}),!i&&!ey(null==t?void 0:t.id)&&(0,A.jsxs)("div",{style:{paddingTop:12},children:[(0,A.jsx)(n7,{}),(0,A.jsx)(t_,{icon:(0,A.jsx)(nk,{}),variant:"secondary",onClick:()=>{n(),e()},children:r.disconnect})]})]})})},rh=(0,B.i7)`
  from{ transform: rotate(0deg); }
  to{   transform: rotate(360deg); }
`,ru=(0,B.i7)`
...
`,rm=eL(W.P.div)`
  ...
  ${({$connected:e})=>e&&(0,B.AH)`
    ...
    `};
`,rf=({showSignOutButton:e,onSignIn:n,onSignOut:t})=>{let o=iR(),i=nU(),{setOpen:r}=rF(),{isSignedIn:a,isReady:s,isLoading:l,isRejected:d,isSuccess:p,isError:h,signIn:u,signOut:g,error:x}=nE({onSignIn:e=>null==n?void 0:n(e),onSignOut:()=>null==t?void 0:t()}),{address:b}=(0,c.F)();return o?e&&a?(0,A.jsx)(t_,{style:{margin:0},onClick:g,icon:(0,A.jsx)(nk,{}),children:i.signOut},"button"):b?(0,A.jsx)(t_,{style:{margin:0},arrow:!a&&!l&&!d,onClick:l||p?void 0:u,disabled:l,waiting:l,icon:d&&(0,A.jsx)(W.P.div,{initial:{rotate:-270},animate:{rotate:0},transition:{duration:1,ease:[.175,.885,.32,.98]},children:(0,A.jsx)(ny,{style:{opacity:.4}})}),children:p?i.signedIn:d?i.tryAgain:l?i.awaitingConfirmation:h?null!=x?x:"Unknown Error":i.signIn},"button"):(0,A.jsx)(t_,{style:{margin:0},onClick:()=>r(!0),arrow:!0,children:i.walletNotConnected},"button"):(0,A.jsx)(t_,{style:{margin:0},disabled:!0},"loading")},rk=({src:e,alt:n,width:t,height:o})=>{let i=(0,I.useRef)(null),[r,a]=(0,I.useState)(!0);return(0,I.useEffect)(()=>{i.current&&i.current.complete&&0!==i.current.naturalHeight||a(!1)},[e]),(0,A.jsx)("div",{style:{width:t,height:o,background:"rgba(0,0,0,0.02)",boxShadow:"inset 0 0 0 1px rgba(0,0,0,0.02)"},children:(0,A.jsx)("img",{ref:i,src:e,alt:n,width:t,height:o,onLoad:()=>a(!0),style:{transition:"opacity 0.2s ease",opacity:+!!r}})})},rv={duration:.2,ease:[.26,.08,.25,1]},rw={duration:.16,ease:[.26,.08,.25,1]},ry=()=>{var e,n;let t=rM(),{isSignedIn:o,reset:i}=nE(),r=em(),[a,s]=(0,I.useState)(o?"signedIn":"signedOut"),l=nU({}),d="signedIn"===a?{heading:l.signInWithEthereumScreen_signedIn_heading,h1:l.signInWithEthereumScreen_signedIn_h1,p:l.signInWithEthereumScreen_signedIn_p,button:l.signInWithEthereumScreen_signedIn_button}:{heading:l.signInWithEthereumScreen_signedOut_heading,h1:l.signInWithEthereumScreen_signedOut_h1,p:l.signInWithEthereumScreen_signedOut_p,button:l.signInWithEthereumScreen_signedOut_button};(0,I.useEffect)(()=>{o&&s("signedIn")},[]),(0,I.useEffect)(()=>{o||s("signedOut")},[o]);let{address:p}=(0,c.F)(),h=(()=>{let e={svg:null,default:null};return Array.from(document.getElementsByTagName("link")).forEach(n=>{("icon"===n.getAttribute("rel")||"shortcut icon"===n.getAttribute("rel"))&&n.getAttribute("href")&&("image/svg+xml"===n.getAttribute("type")?e.svg=n.getAttribute("href"):e.default=n.getAttribute("href"))}),e})(),u=null!=(n=null!=(e=X())?e:h.svg)?n:h.default;return(0,A.jsx)(eX,{style:{width:278},children:(0,A.jsxs)(e$,{style:{padding:0,marginTop:-10},children:[(0,A.jsx)(rg,{children:(0,A.jsx)(T.N,{exitBeforeEnter:!0,children:(0,A.jsx)(W.P.div,{initial:!r&&{opacity:0,scale:.94},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.94},transition:rw,children:(0,A.jsx)(e0,{style:{height:42},children:(0,A.jsx)(nX,{children:d.h1})})},ef(d.h1).toString())})}),(0,A.jsxs)(rm,{$connected:o,children:[(0,A.jsx)("div",{style:{position:"absolute",inset:0},children:(0,A.jsx)(rC,{width:"262",height:"134",viewBox:"0 0 262 134",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,A.jsx)(W.P.rect,{x:"0",y:"0",rx:"12",width:"262",height:"134",strokeDasharray:"3 3",animate:{strokeDashoffset:[0,-6]},transition:{duration:.4,ease:"linear",repeat:1/0}})})}),(0,A.jsx)(W.P.div,{initial:!r&&{opacity:0,x:50,scale:.8},animate:{opacity:1,x:0,scale:1},transition:rv,children:(0,A.jsx)(rx,{children:(0,A.jsx)(iZ,{address:p,size:64})})},"avatarImage"),(0,A.jsx)(W.P.div,{initial:!r&&{scale:.6},animate:{scale:1},transition:{...rv},children:(0,A.jsx)(rb,{children:(0,A.jsx)(nv,{})})},"tickIcon"),(0,A.jsx)(W.P.div,{initial:!r&&{opacity:0,x:-40,scale:.8},animate:{opacity:1,x:0,scale:1},transition:{...rv},children:(0,A.jsx)(rx,{children:u?(0,A.jsx)(rk,{src:u,alt:"app"}):(0,A.jsx)(iP.UnknownChain,{})})},"appLogo")]},"status"),(0,A.jsx)(T.N,{exitBeforeEnter:!0,children:(0,A.jsx)(W.P.div,{style:{paddingBottom:r?24:12},initial:!r&&{opacity:0,scale:.94},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.94},transition:rw,children:(0,A.jsx)(e0,{style:{height:42,marginTop:-1,marginBottom:-3},children:(0,A.jsx)(nX,{children:d.p})})},ef(d.p).toString())}),(0,A.jsx)(rf,{showSignOutButton:"signedIn"===a,onSignIn:()=>{setTimeout(()=>{t.setOpen(!1)},1e3)}})]})})},rj={},rS=({mode:e="auto",theme:n="auto",customTheme:t=rj,lang:o="en-US"})=>{var i;let r=rM(),{isConnected:a,chain:s}=(0,c.F)(),l=ol(null==s?void 0:s.id),d=!((null==(i=r.options)?void 0:i.enforceSupportedChains)&&a&&!l),p=d&&r.route!==rE.CONNECTORS&&r.route!==rE.PROFILE,h=d&&r.route!==rE.PROFILE,u={onboarding:(0,A.jsx)(tM,{}),about:(0,A.jsx)(t2,{}),download:(0,A.jsx)(iM,{}),connectors:(0,A.jsx)(oI,{}),mobileConnectors:(0,A.jsx)(oV,{}),connect:(0,A.jsx)(i_,{}),profile:(0,A.jsx)(rd,{}),switchNetworks:(0,A.jsx)(rp,{}),signInWithEthereum:(0,A.jsx)(ry,{})};function g(){r.setOpen(!1)}return(0,I.useEffect)(()=>{var e;a?(r.route!==rE.PROFILE||r.route!==rE.SIGNINWITHETHEREUM)&&(!r.signInWithEthereum||(null==(e=r.options)?void 0:e.disableSiweRedirect)?g():r.setRoute(rE.SIGNINWITHETHEREUM)):g()},[a]),(0,I.useEffect)(()=>r.setMode(e),[e]),(0,I.useEffect)(()=>r.setTheme(n),[n]),(0,I.useEffect)(()=>r.setCustomTheme(t),[t]),(0,I.useEffect)(()=>r.setLang(o),[o]),(0,I.useEffect)(()=>{let e=Q();if(!e||!r.open)return;let n=document.createElement("meta");return n.setAttribute("property","og:title"),n.setAttribute("content",e),document.head.prepend(n),()=>{document.head.removeChild(n)}},[r.open]),(0,A.jsx)(nb,{theme:n,customTheme:t,mode:e,children:(0,A.jsx)(n8,{open:r.open,pages:u,pageId:r.route,onClose:d?g:void 0,onInfo:h?()=>r.setRoute(rE.ABOUT):void 0,onBack:p?()=>{r.route===rE.SIGNINWITHETHEREUM||r.route===rE.SWITCHNETWORKS?r.setRoute(rE.PROFILE):r.route===rE.DOWNLOAD?r.setRoute(rE.CONNECT):r.setRoute(rE.CONNECTORS)}:void 0})})},rN=({onConnect:e,onDisconnect:n})=>{(0,f.U)({onConnect:({address:n,connector:t,isReconnected:o})=>{o||null==e||e({address:n,connectorId:null==t?void 0:t.id})},onDisconnect:()=>null==n?void 0:n()})},rE={ONBOARDING:"onboarding",ABOUT:"about",CONNECTORS:"connectors",MOBILECONNECTORS:"mobileConnectors",CONNECT:"connect",DOWNLOAD:"download",PROFILE:"profile",SWITCHNETWORKS:"switchNetworks",SIGNINWITHETHEREUM:"signInWithEthereum"},rL=(0,I.createContext)(null),r_=({children:e,theme:n="auto",mode:t="auto",customTheme:o,options:i,onConnect:r,onDisconnect:a,debugMode:s=!1})=>{var l,d,p,h;if(!I.useContext(k.R))throw Error("ConnectKitProvider must be within a WagmiProvider");if(I.useContext(rL))throw Error("Multiple, nested usages of ConnectKitProvider detected. Please use only one.");rN({onConnect:r,onDisconnect:a});let u=os(),g=nq("injected"),x=Object.assign({},{language:"en-US",hideBalance:!1,hideTooltips:!1,hideQuestionMarkCTA:!1,hideNoWalletCTA:!1,walletConnectCTA:"link",hideRecentBadge:!1,avoidLayoutShift:!0,embedGoogleFonts:!1,truncateLongENSAddress:!0,walletConnectName:void 0,reducedMotion:!1,disclaimer:null,bufferPolyfill:!0,customAvatar:void 0,initialChainId:null==(l=null==u?void 0:u[0])?void 0:l.id,enforceSupportedChains:!1,ethereumOnboardingUrl:void 0,walletOnboardingUrl:void 0,disableSiweRedirect:!1},i);"undefined"!=typeof window&&x.bufferPolyfill&&(window.Buffer=null!=(d=window.Buffer)?d:O.Buffer);let[b,C]=(0,I.useState)(n),[m,f]=(0,I.useState)(t),[v,w]=(0,I.useState)(null!=o?o:{}),[y,j]=(0,I.useState)("en-US"),[S,N]=(0,I.useState)(!1),[E,L]=(0,I.useState)({id:""}),[_,M]=(0,I.useState)(rE.CONNECTORS),[F,W]=(0,I.useState)(""),[T,z]=(0,I.useState)(0);x.embedGoogleFonts&&function(e){var n,t;let o=null!=(n=({web95:"Lato",retro:"Nunito",midnight:"Inter",minimal:"Inter",rounded:"Nunito"})[e])?n:null;t=null!=o?o:"",(0,I.useEffect)(()=>{if(!t)return;t=t.replace(/ /g,"+");let e=document.createElement("link");e.href="https://fonts.googleapis.com",e.rel="preconnect";let n=document.createElement("link");n.href="https://fonts.gstatic.com",n.rel="preconnect",n.crossOrigin="true";let o=document.createElement("link");return o.href=`https://fonts.googleapis.com/css2?family=${t}:wght@400;500;600&display=swap`,o.rel="stylesheet",document.head.appendChild(e),document.head.appendChild(n),document.head.appendChild(o),()=>{document.head.removeChild(e),document.head.removeChild(n),document.head.removeChild(o)}},[t])}(n),(0,I.useEffect)(()=>C(n),[n]),(0,I.useEffect)(()=>j(x.language||"en-US"),[x.language]),(0,I.useEffect)(()=>W(null),[_,S]);let{chain:D,isConnected:R}=(0,c.F)(),H=ol(null==D?void 0:D.id);(0,I.useEffect)(()=>{R&&x.enforceSupportedChains&&!H&&(N(!0),M(rE.SWITCHNETWORKS))},[R,H,D,_,S]),(0,I.useEffect)(()=>{K()&&(null==g||g.connect())},[g]);let U=s?console.log:()=>{},Z={theme:b,setTheme:C,mode:m,setMode:f,customTheme:o,setCustomTheme:w,lang:y,setLang:j,open:S,setOpen:N,route:_,setRoute:M,connector:E,setConnector:L,signInWithEthereum:null!=(h=null==(p=I.useContext(nN))?void 0:p.enabled)&&h,onConnect:r,options:x,errorMessage:F,debugMode:s,log:U,displayError:(e,n)=>{W(e),console.log("---------CONNECTKIT DEBUG---------"),console.log(e),n&&console.table(n),console.log("---------/CONNECTKIT DEBUG---------")},resize:T,triggerResize:()=>z(e=>e+1)};return(0,I.createElement)(rL.Provider,{value:Z},(0,A.jsx)(A.Fragment,{children:(0,A.jsx)(op,{enabled:S,children:(0,A.jsxs)(B.NP,{theme:eE,children:[e,(0,A.jsx)(rS,{lang:y,theme:b,mode:t,customTheme:v})]})})}))},rM=()=>{let e=I.useContext(rL);if(!e)throw Error("ConnectKit Hook must be inside a Provider.");return e},rA={disconnected:[rE.CONNECTORS,rE.ABOUT,rE.ONBOARDING,rE.MOBILECONNECTORS,rE.ONBOARDING],connected:[rE.PROFILE,rE.SWITCHNETWORKS,rE.SIGNINWITHETHEREUM]},rI=[...rA.connected,...rA.disconnected],rF=({onConnect:e,onDisconnect:n}={})=>{let t=rM();rN({onConnect:e,onDisconnect:n});let{isConnected:o}=(0,c.F)(),{signIn:i}=nE(),r=()=>{t.setOpen(!1)},a=()=>{t.setOpen(!0)},s=e=>{let n=e;rI.includes(e)?o?rA.connected.includes(e)||(n=rE.PROFILE,t.log(`Route ${e} is not a valid route when connected, navigating to ${n} instead.`)):rA.disconnected.includes(e)||(n=rE.CONNECTORS,t.log(`Route ${e} is not a valid route when disconnected, navigating to ${n} instead.`)):(n=o?rE.PROFILE:rE.CONNECTORS,t.log(`Route ${e} is not a valid route, navigating to ${n} instead.`)),t.setRoute(n),a()};return{open:t.open,setOpen:e=>{e?s(o?rE.PROFILE:rE.CONNECTORS):r()},openAbout:()=>s(rE.ABOUT),openOnboarding:()=>s(rE.ONBOARDING),openProfile:()=>s(rE.PROFILE),openSwitchNetworks:()=>s(rE.SWITCHNETWORKS),openSIWE:e=>{s(rE.SIGNINWITHETHEREUM),e&&i()}}},rO=eL(W.P.div)`
  top: 0;
  bottom: 0;
  left: 0;
  display: inline-flex;
...
`,rD=({children:e,variant:n="primary",autoSize:t=!0,duration:o=.3,style:i})=>{let[r,a]=(0,U.A)();return(0,A.jsx)(rz,{className:n,initial:!1,animate:t?{width:a.width>10?a.width:"auto"}:void 0,transition:{duration:o,ease:[.25,1,.5,1],delay:.01},style:i,children:(0,A.jsx)("div",{ref:r,style:{whiteSpace:"nowrap",width:"fit-content",position:"relative",padding:"0 12px"},children:e})})},rR=eL(W.P.div)`
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 8px;
...
`,rZ=({hideIcon:e,hideSymbol:n})=>{let t=iR(),[o,i]=(0,I.useState)(!0),{address:r,chain:a}=(0,c.F)();os();let s=ol(null==a?void 0:a.id),l=(0,R.jE)(),{data:d}=(0,v.y)({watch:!0}),{data:p,queryKey:h}=(0,m.A)({address:r,chainId:null==a?void 0:a.id});(0,I.useEffect)(()=>{(null==d||d)&&l.invalidateQueries({queryKey:h})},[d,h]);let u=iV.find(e=>e.id===(null==a?void 0:a.id)),g=`${!t||(null==p?void 0:p.formatted)===void 0?"balance-loading":`balance-${null==u?void 0:u.id}-${null==p?void 0:p.formatted}`}`;return(0,I.useEffect)(()=>{i(!1)},[]),(0,A.jsx)("div",{style:{position:"relative"},children:(0,A.jsx)(T.N,{initial:!1,children:(0,A.jsx)(W.P.div,{initial:(null==p?void 0:p.formatted)!==void 0&&o?{opacity:1}:{opacity:0,position:"absolute",top:0,left:0,bottom:0},animate:{opacity:1,position:"relative"},exit:{opacity:0,position:"absolute",top:0,left:0,bottom:0},transition:{duration:.4,ease:[.25,1,.5,1],delay:.4},children:r&&t&&(null==p?void 0:p.formatted)!==void 0?s?(0,A.jsxs)(rR,{children:[!e&&(0,A.jsx)(rr,{id:null==a?void 0:a.id}),(0,A.jsx)("span",{style:{minWidth:32},children:eu(Number(null==p?void 0:p.formatted))}),!n&&` ${null==p?void 0:p.symbol}`]}):(0,A.jsxs)(rR,{children:[!e&&(0,A.jsx)(rr,{id:null==a?void 0:a.id}),(0,A.jsx)("span",{style:{minWidth:32},children:"???"})]}):(0,A.jsxs)(rR,{children:[!e&&(0,A.jsx)(rr,{id:null==a?void 0:a.id}),(0,A.jsx)("span",{style:{minWidth:32},children:(0,A.jsxs)(rU,{children:[(0,A.jsx)("span",{style:{animationDelay:"0ms"}}),(0,A.jsx)("span",{style:{animationDelay:"50ms"}}),(0,A.jsx)("span",{style:{animationDelay:"100ms"}})]})})]})},g)})})},rG={initial:{zIndex:2,opacity:0,x:"-100%"},animate:{opacity:1,x:.1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,opacity:0,x:"-100%",pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},rP={initial:{zIndex:2,opacity:0,x:"100%"},animate:{x:.2,opacity:1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,x:"100%",opacity:0,pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},rV={initial:{opacity:0},animate:{opacity:1,transition:{duration:.3,ease:[.25,1,.5,1]}},exit:{position:"absolute",opacity:0,transition:{duration:.3,ease:[.25,1,.5,1]}}},rY=({children:e})=>{let n=iR(),t=rM(),{open:o,setOpen:i}=rF(),{address:r,isConnected:a,chain:s}=(0,c.F)(),l=ol(null==s?void 0:s.id),d=iU(),{data:p}=(0,g.v)({chainId:1,address:r,config:d});return e&&n?(0,A.jsx)(A.Fragment,{children:e({show:function(){i(!0),t.setRoute(a?rE.PROFILE:rE.CONNECTORS)},hide:function(){i(!1)},chain:s,unsupported:!l,isConnected:!!r,isConnecting:o,address:r,truncatedAddress:r?ep(r):void 0,ensName:null==p?void 0:p.toString()})}):null};function rQ({label:e,showAvatar:n,separator:t}){var o;let i=nU({}),r=rM(),{isSignedIn:a}=nE(),{address:s,chain:l}=(0,c.F)(),d=ol(null==l?void 0:l.id),p=iU(),{data:h}=(0,g.v)({chainId:1,address:s,config:p}),u=i.connectWallet;return(0,A.jsx)(T.N,{initial:!1,children:s?(0,A.jsxs)(rO,{initial:"initial",animate:"animate",exit:"exit",variants:rP,style:{height:40},children:[n&&(0,A.jsxs)(rW,{children:[(0,A.jsxs)(T.N,{initial:!1,children:[a&&(0,A.jsx)(W.P.div,{style:{zIndex:2,position:"absolute",bottom:0,right:0},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,A.jsx)(nS,{})}),!d&&(0,A.jsx)(rT,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,A.jsx)("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,A.jsx)("path",{d:"M1.68831 13.5H12.0764C13.1026 13.5 13.7647 12.7197 13.7647 11.763C13.7647 11.4781 13.6985 11.1863 13.5462 10.9149L8.34225 1.37526C8.02445 0.791754 7.45505 0.5 6.88566 0.5C6.31627 0.5 5.73364 0.791754 5.42246 1.37526L0.225108 10.9217C0.0728291 11.1863 0 11.4781 0 11.763C0 12.7197 0.662083 13.5 1.68831 13.5ZM6.88566 8.8048C6.49503 8.8048 6.27655 8.5809 6.26331 8.1738L6.16399 5.0595C6.15075 4.64562 6.44869 4.34708 6.87904 4.34708C7.30278 4.34708 7.61396 4.6524 7.60071 5.06628L7.5014 8.16701C7.48154 8.5809 7.26305 8.8048 6.88566 8.8048ZM6.88566 11.3492C6.44207 11.3492 6.07792 11.0303 6.07792 10.5757C6.07792 10.1211 6.44207 9.80219 6.88566 9.80219C7.32926 9.80219 7.69341 10.1143 7.69341 10.5757C7.69341 11.0371 7.32264 11.3492 6.88566 11.3492Z",fill:"currentColor"})})})]}),(0,A.jsx)(iZ,{size:24,address:s})]}),(0,A.jsx)("div",{style:{position:"relative",paddingRight:+!!n},children:(0,A.jsx)(T.N,{initial:!1,children:h?(0,A.jsx)(rO,{initial:"initial",animate:"animate",exit:"exit",variants:rV,style:{position:h?"relative":"absolute"},children:(null==(o=r.options)?void 0:o.truncateLongENSAddress)?eh(h,20):h},"ckEnsName"):(0,A.jsxs)(rO,{initial:"initial",animate:"animate",exit:"exit",variants:rV,style:{position:h?"absolute":"relative"},children:[ep(s,t)," "]},"ckTruncatedAddress")})})]},"connectedText"):(0,A.jsx)(rO,{initial:"initial",animate:"animate",exit:"exit",variants:rG,style:{height:40},children:e||u},"connectWalletText")})}function rX({label:e,showBalance:n=!1,showAvatar:t=!0,theme:o,mode:i,customTheme:r,onClick:a}){var s;let l=iR(),d=rM(),{isConnected:p,address:h,chain:u}=(0,c.F)(),g=ol(null==u?void 0:u.id);function x(){d.setOpen(!0),d.setRoute(p?rE.PROFILE:rE.CONNECTORS)}let b=["web95","rounded","minimal"].includes(null!=(s=null!=o?o:d.theme)?s:"")?"....":void 0;if(!l)return null;let C=n&&g,m=h&&C;return(0,A.jsx)(eD,{$useTheme:null!=o?o:d.theme,$useMode:null!=i?i:d.mode,$customTheme:null!=r?r:d.customTheme,children:(0,A.jsxs)(rB,{onClick:()=>{a?a(x):x()},children:[C&&(0,A.jsx)(T.N,{initial:!1,children:m&&(0,A.jsx)(W.P.div,{initial:{opacity:0,x:"100%",width:0,marginRight:0},animate:{opacity:1,x:0,width:"auto",marginRight:-24,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{opacity:0,x:"100%",width:0,marginRight:0,transition:{duration:.4,ease:[.25,1,.5,1]}},children:(0,A.jsx)(rD,{variant:"secondary",theme:null!=o?o:d.theme,mode:null!=i?i:d.mode,customTheme:null!=r?r:d.customTheme,style:{overflow:"hidden"},children:(0,A.jsx)(W.P.div,{style:{paddingRight:24},children:(0,A.jsx)(rZ,{hideSymbol:!0})})})},"balance")}),(0,A.jsx)(rD,{theme:null!=o?o:d.theme,mode:null!=i?i:d.mode,customTheme:null!=r?r:d.customTheme,style:C&&n&&h&&("retro"===o||"retro"===d.theme)?{boxShadow:"var(--ck-connectbutton-balance-connectbutton-box-shadow)",borderRadius:"var(--ck-connectbutton-balance-connectbutton-border-radius)",overflow:"hidden"}:{overflow:"hidden"},children:(0,A.jsx)(rQ,{separator:b,showAvatar:t,label:e})})]})})}rY.displayName="ConnectKitButton.Custom",rX.Custom=rY;let rJ=(0,B.i7)`
  0%{ transform:none; }
