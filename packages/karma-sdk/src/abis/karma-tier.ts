export const karmaTierAbi = [
  ...
  { inputs: [], name: 'EmptyTierName', type: 'error' },
  { inputs: [], name: 'EmptyTiersArray', type: 'error' },
  {
    inputs: [
  ...
  { inputs: [], name: 'InvalidTxAmount', type: 'error' },
  {
    inputs: [
      { internalType: 'uint8', name: 'index', type: 'uint8' },
      { internalType: 'uint256', name: 'expectedMinKarma', type: 'uint256' },
      { internalType: 'uint256', name: 'actualMinKarma', type: 'uint256' },
    ],
  ...
  { inputs: [], name: 'TierNotFound', type: 'error' },
  {
    anonymous: false,
    inputs: [
      {
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'karmaBalance', type: 'uint256' },
    ],
