...
const buttonStyles = cva({
  ...
  variants: {
    variant: {
      ...
      outline:
        'border-neutral-30 bg-[transparent] text-neutral-100 hover:border-neutral-40',
    },
    withIcon: {
      true: '',
      false: '',
