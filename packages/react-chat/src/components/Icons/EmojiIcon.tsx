...
export const EmojiIcon = ({ theme }: ThemeProps) => {
  return (
    <Icon width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg' theme={theme}>
      <path
        fillRule='evenodd'
        clipRule='evenodd'
      ...
      <path d='M15 8.5C15 9.32843 14.3284 10 13.5 10C12.6716 10 12 9.32843 12 8.5C12 7.67157 12.6716 7 13.5 7C14.3284 7 15 7.67157 15 8.5Z' />
      <path d='M8 8.5C8 9.32843 7.32843 10 6.5 10C5.67157 10 5 9.32843 5 8.5C5 7.67157 5.67157 7 6.5 7C7.32843 7 8 7.67157 8 8.5Z' />
    </Icon>
  );
};
