        ...
        <Modal name={UserCreationModalName} >
            ...
            <MiddleSection>
                <Content>
                    ...
                    <StyledHint>Longer and unusual names are better as they are less likely to be used by someone else.</StyledHint>
                    <LogoWrapper>
                        <UserLogo text={customNameInput.slice(0,2)} radius={80} colorWheel={[['red', 150], ['blue', 250], ['green', 360]]} />
                    </LogoWrapper>
                    <NameInput
